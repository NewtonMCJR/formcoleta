 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function lt(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function $m(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(lt())}function Hm(){var e;const n=(e=Ia())==null?void 0:e.forceEnvironment;if(n==="node")return!0;if(n==="browser")return!1;try{return Object.prototype.toString.call(global.process)==="[object process]"}catch{return!1}}function jm(){return typeof navigator<"u"&&navigator.userAgent==="Cloudflare-Workers"}function qm(){const n=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof n=="object"&&n.id!==void 0}function zm(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function Gm(){const n=lt();return n.indexOf("MSIE ")>=0||n.indexOf("Trident/")>=0}function Wm(){return!Hm()&&!!navigator.userAgent&&navigator.userAgent.includes("Safari")&&!navigator.userAgent.includes("Chrome")}function Km(){try{return typeof indexedDB=="object"}catch{return!1}}function Ym(){return new Promise((n,e)=>{try{let t=!0;const r="validate-browser-context-for-indexeddb-analytics-module",s=self.indexedDB.open(r);s.onsuccess=()=>{s.result.close(),t||self.indexedDB.deleteDatabase(r),n(!0)},s.onupgradeneeded=()=>{t=!1},s.onerror=()=>{var i;e(((i=s.error)==null?void 0:i.message)||"")}}catch(t){e(t)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yl="[DEFAULT]",X6={[Kl]:"fire-core",[T6]:"fire-core-compat",[I6]:"fire-analytics",[x6]:"fire-analytics-compat",[R6]:"fire-app-check",[C6]:"fire-app-check-compat",[S6]:"fire-auth",[P6]:"fire-auth-compat",[k6]:"fire-rtdb",[O6]:"fire-data-connect",[N6]:"fire-rtdb-compat",[D6]:"fire-fn",[L6]:"fire-fn-compat",[V6]:"fire-iid",[M6]:"fire-iid-compat",[B6]:"fire-fcm",[F6]:"fire-fcm-compat",[U6]:"fire-perf",[$6]:"fire-perf-compat",[H6]:"fire-rc",[j6]:"fire-rc-compat",[q6]:"fire-gcs",[z6]:"fire-gcs-compat",[G6]:"fire-fst",[K6]:"fire-fst-compat",[W6]:"fire-vertex","fire-js":"fire-js",[Y6]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ko=new xc("@firebase/auth");function dg(n,...e){Ko.logLevel<=fe.WARN&&Ko.warn(`Auth (${$r}): ${n}`,...e)}function Do(n,...e){Ko.logLevel<=fe.ERROR&&Ko.error(`Auth (${$r}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Sc(n,e){An(n.emulator,"Emulator should always be set here");const{url:t}=n.emulator;return e?`${t}${e.startsWith("/")?e.slice(1):e}`:t}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ih(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(A2(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(y2(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(x2(e))return"Blackberry";if(I2(e))return"Webos";if(v2(e))return"Safari";if((e.includes("chrome/")||E2(e))&&!e.includes("edge/"))return"Chrome";if(T2(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=n.match(t);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function y2(n=lt()){return/firefox\//i.test(n)}function v2(n=lt()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function E2(n=lt()){return/crios\//i.test(n)}function A2(n=lt()){return/iemobile/i.test(n)}function T2(n=lt()){return/android/i.test(n)}function x2(n=lt()){return/blackberry/i.test(n)}function I2(n=lt()){return/webos/i.test(n)}function kc(n=lt()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function kg(n=lt()){var e;return kc(n)&&!!((e=window.navigator)!=null&&e.standalone)}function Og(){return Gm()&&document.documentMode===10}function C2(n=lt()){return kc(n)||T2(n)||I2(n)||x2(n)||/windows phone/i.test(n)||A2(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function R2(n,e=[]){let t;switch(n){case"Browser":t=ih(lt());break;case"Worker":t=`${ih(lt())}-${n}`;break;default:t=n}const r=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${$r}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class z2{constructor(e,t,r,s,i=!1){this.auth=e,this.resolver=r,this.user=s,this.bypassAuthState=i,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:r,postBody:s,tenantId:i,error:o,type:l}=e;if(o){this.reject(o);return}const c={auth:this.auth,requestUri:t,sessionId:r,tenantId:i||void 0,postBody:s||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(l)(c))}catch(h){this.reject(h)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return R4;case"linkViaPopup":case"linkViaRedirect":return P4;case"reauthViaPopup":case"reauthViaRedirect":return S4;default:qt(this.auth,"internal-error")}}resolve(e){An(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){An(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vr=new xc("@firebase/firestore");function ts(){return Vr.logLevel}function j(n,...e){if(Vr.logLevel<=fe.DEBUG){const t=e.map(Vc);Vr.debug(`Firestore (${Es}): ${n}`,...t)}}function Tn(n,...e){if(Vr.logLevel<=fe.ERROR){const t=e.map(Vc);Vr.error(`Firestore (${Es}): ${n}`,...t)}}function zt(n,...e){if(Vr.logLevel<=fe.WARN){const t=e.map(Vc);Vr.warn(`Firestore (${Es}): ${n}`,...t)}}function Vc(n){if(typeof n=="string")return n;try{return function(t){return JSON.stringify(t)}(n)}catch{return n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function J(n,e,t){let r="Unexpected state";typeof e=="string"?r=e:t=e,ef(n,r,t)}function ef(n,e,t){let r=`FIRESTORE (${Es}) INTERNAL ASSERTION FAILED: ${e} (ID: ${n.toString(16)})`;if(t!==void 0)try{r+=" CONTEXT: "+JSON.stringify(t)}catch{r+=" CONTEXT: "+t}throw Tn(r),new Error(r)}function W(n,e,t,r){let s="Unexpected state";typeof t=="string"?s=t:r=t,n||ef(e,s,r)}function oe(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tf{constructor(e,t){this.user=t,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class L7{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,t){e.enqueueRetryable(()=>t(ot.UNAUTHENTICATED))}shutdown(){}}class V7{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,t){this.changeListener=t,e.enqueueRetryable(()=>t(this.token.user))}shutdown(){this.changeListener=null}}class M7{constructor(e){this.t=e,this.currentUser=ot.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,t){W(this.o===void 0,42304);let r=this.i;const s=c=>this.i!==r?(r=this.i,t(c)):Promise.resolve();let i=new _n;this.o=()=>{this.i++,this.currentUser=this.u(),i.resolve(),i=new _n,e.enqueueRetryable(()=>s(this.currentUser))};const o=()=>{const c=i;e.enqueueRetryable(async()=>{await c.promise,await s(this.currentUser)})},l=c=>{j("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=c,this.o&&(this.auth.addAuthTokenListener(this.o),o())};this.t.onInit(c=>l(c)),setTimeout(()=>{if(!this.auth){const c=this.t.getImmediate({optional:!0});c?l(c):(j("FirebaseAuthCredentialsProvider","Auth not yet detected"),i.resolve(),i=new _n)}},0),o()}getToken(){const e=this.i,t=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(t).then(r=>this.i!==e?(j("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):r?(W(typeof r.accessToken=="string",31837,{l:r}),new tf(r.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const e=this.auth&&this.auth.getUid();return W(e===null||typeof e=="string",2055,{h:e}),new ot(e)}}class B7{constructor(e,t,r){this.T=e,this.P=t,this.R=r,this.type="FirstParty",this.user=ot.FIRST_PARTY,this.I=new Map}A(){return this.R?this.R():null}get headers(){this.I.set("X-Goog-AuthUser",this.T);const e=this.A();return e&&this.I.set("Authorization",e),this.P&&this.I.set("X-Goog-Iam-Authorization-Token",this.P),this.I}}class F7{constructor(e,t,r){this.T=e,this.P=t,this.R=r}getToken(){return Promise.resolve(new B7(this.T,this.P,this.R))}start(e,t){e.enqueueRetryable(()=>t(ot.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class jh{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class U7{constructor(e,t){this.V=t,this.forceRefresh=!1,this.appCheck=null,this.m=null,this.p=null,Pt(e)&&e.settings.appCheckToken&&(this.p=e.settings.appCheckToken)}start(e,t){W(this.o===void 0,3512);const r=i=>{i.error!=null&&j("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${i.error.message}`);const o=i.token!==this.m;return this.m=i.token,j("FirebaseAppCheckTokenProvider",`Received ${o?"new":"existing"} token.`),o?t(i.token):Promise.resolve()};this.o=i=>{e.enqueueRetryable(()=>r(i))};const s=i=>{j("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=i,this.o&&this.appCheck.addTokenListener(this.o)};this.V.onInit(i=>s(i)),setTimeout(()=>{if(!this.appCheck){const i=this.V.getImmediate({optional:!0});i?s(i):j("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){if(this.p)return Promise.resolve(new jh(this.p));const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(t=>t?(W(typeof t.token=="string",44558,{tokenResult:t}),this.m=t.token,new jh(t.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mc{static newId(){const e="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",t=62*Math.floor(4.129032258064516);let r="";for(;r.length<20;){const s=$7(40);for(let i=0;i<s.length;++i)r.length<20&&s[i]<t&&(r+=e.charAt(s[i]%62))}return r}}function de(n,e){return n<e?-1:n>e?1:0}function nc(n,e){const t=Math.min(n.length,e.length);for(let r=0;r<t;r++){const s=n.charAt(r),i=e.charAt(r);if(s!==i)return Nl(s)===Nl(i)?de(s,i):Nl(s)?1:-1}return de(n.length,e.length)}const H7=55296,j7=57343;function Nl(n){const e=n.charCodeAt(0);return e>=H7&&e<=j7}function fs(n,e,t){return n.length===e.length&&n.every((r,s)=>t(r,e[s]))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class je{constructor(e){this.binaryString=e}static fromBase64String(e){const t=function(s){try{return atob(s)}catch(i){throw typeof DOMException<"u"&&i instanceof DOMException?new of("Invalid base64 string: "+i):i}}(e);return new je(t)}static fromUint8Array(e){const t=function(s){let i="";for(let o=0;o<s.length;++o)i+=String.fromCharCode(s[o]);return i}(e);return new je(t)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return function(t){return btoa(t)}(this.binaryString)}toUint8Array(){return function(t){const r=new Uint8Array(t.length);for(let s=0;s<t.length;s++)r[s]=t.charCodeAt(s);return r}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return de(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}je.EMPTY_BYTE_STRING=new je("");const r3=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function sr(n){if(W(!!n,39018),typeof n=="string"){let e=0;const t=r3.exec(n);if(W(!!t,46558,{timestamp:n}),t[1]){let s=t[1];s=(s+"000000000").substr(0,9),e=Number(s)}const r=new Date(n);return{seconds:Math.floor(r.getTime()/1e3),nanos:e}}return{seconds:Se(n.seconds),nanos:Se(n.nanos)}}function Se(n){return typeof n=="number"?n:typeof n=="string"?Number(n):0}function ir(n){return typeof n=="string"?je.fromBase64String(n):je.fromUint8Array(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Be,me;function O3(n){switch(n){case V.OK:return J(64938);case V.CANCELLED:case V.UNKNOWN:case V.DEADLINE_EXCEEDED:case V.RESOURCE_EXHAUSTED:case V.INTERNAL:case V.UNAVAILABLE:case V.UNAUTHENTICATED:return!1;case V.INVALID_ARGUMENT:case V.NOT_FOUND:case V.ALREADY_EXISTS:case V.PERMISSION_DENIED:case V.FAILED_PRECONDITION:case V.ABORTED:case V.OUT_OF_RANGE:case V.UNIMPLEMENTED:case V.DATA_LOSS:return!0;default:return J(15467,{code:n})}}function Sf(n){if(n===void 0)return Tn("GRPC error has no .code"),V.UNKNOWN;switch(n){case Be.OK:return V.OK;case Be.CANCELLED:return V.CANCELLED;case Be.UNKNOWN:return V.UNKNOWN;case Be.DEADLINE_EXCEEDED:return V.DEADLINE_EXCEEDED;case Be.RESOURCE_EXHAUSTED:return V.RESOURCE_EXHAUSTED;case Be.INTERNAL:return V.INTERNAL;case Be.UNAVAILABLE:return V.UNAVAILABLE;case Be.UNAUTHENTICATED:return V.UNAUTHENTICATED;case Be.INVALID_ARGUMENT:return V.INVALID_ARGUMENT;case Be.NOT_FOUND:return V.NOT_FOUND;case Be.ALREADY_EXISTS:return V.ALREADY_EXISTS;case Be.PERMISSION_DENIED:return V.PERMISSION_DENIED;case Be.FAILED_PRECONDITION:return V.FAILED_PRECONDITION;case Be.ABORTED:return V.ABORTED;case Be.OUT_OF_RANGE:return V.OUT_OF_RANGE;case Be.UNIMPLEMENTED:return V.UNIMPLEMENTED;case Be.DATA_LOSS:return V.DATA_LOSS;default:return J(39323,{code:n})}}(me=Be||(Be={}))[me.OK=0]="OK",me[me.CANCELLED=1]="CANCELLED",me[me.UNKNOWN=2]="UNKNOWN",me[me.INVALID_ARGUMENT=3]="INVALID_ARGUMENT",me[me.DEADLINE_EXCEEDED=4]="DEADLINE_EXCEEDED",me[me.NOT_FOUND=5]="NOT_FOUND",me[me.ALREADY_EXISTS=6]="ALREADY_EXISTS",me[me.PERMISSION_DENIED=7]="PERMISSION_DENIED",me[me.UNAUTHENTICATED=16]="UNAUTHENTICATED",me[me.RESOURCE_EXHAUSTED=8]="RESOURCE_EXHAUSTED",me[me.FAILED_PRECONDITION=9]="FAILED_PRECONDITION",me[me.ABORTED=10]="ABORTED",me[me.OUT_OF_RANGE=11]="OUT_OF_RANGE",me[me.UNIMPLEMENTED=12]="UNIMPLEMENTED",me[me.INTERNAL=13]="INTERNAL",me[me.UNAVAILABLE=14]="UNAVAILABLE",me[me.DATA_LOSS=15]="DATA_LOSS";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const N3=new Ce(X.comparator);function vt(){return N3}const Pf=new Ce(X.comparator);function ns(...n){let e=Pf;for(const t of n)e=e.insert(t.key,t);return e}function kf(n){let e=Pf;return n.forEach((t,r)=>e=e.insert(t,r.overlayedDocument)),e}function Hn(){return pi()}function Of(){return pi()}function pi(){return new zr(n=>n.toString(),(n,e)=>n.isEqual(e))}const D3=new Ce(X.comparator),L3=new He(X.comparator);function he(...n){let e=L3;for(const t of n)e=e.add(t);return e}const V3=new He(de);function M3(){return V3}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yi{constructor(e,t,r,s,i,o){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=r,this.documentUpdates=s,this.augmentedDocumentUpdates=i,this.resolvedLimboDocuments=o}static createSynthesizedRemoteEventForCurrentChange(e,t,r){const s=new Map;return s.set(e,Qi.createSynthesizedTargetChangeForCurrentChange(e,t,r)),new Yi(se.min(),s,new Ce(de),vt(),vt(),he())}}class Qi{constructor(e,t,r,s,i){this.resumeToken=e,this.current=t,this.addedDocuments=r,this.modifiedDocuments=s,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(e,t,r){return new Qi(r,t,he(),he(),he())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yc{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new z(V.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Ge(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}function s9(){return new Yc(Qt)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class on{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new z(V.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new z(V.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return de(this._lat,e._lat)||de(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:on._jsonSchemaVersion}}static fromJSON(e){if(Gi(e,on._jsonSchema))return new on(e.latitude,e.longitude)}}function zf(n){const e={};return n.timeoutSeconds!==void 0&&(e.timeoutSeconds=n.timeoutSeconds),e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */on._jsonSchemaVersion="firestore/geoPoint/1.0",on._jsonSchema={type:Ue("string",on._jsonSchemaVersion),latitude:Ue("number"),longitude:Ue("number")};class i9{bt(e){}shutdown(){}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ll="RestConnection",o9={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery",ExecutePipeline:"executePipeline"};class a9{get Ot(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const t=e.ssl?"https":"http",r=encodeURIComponent(this.databaseId.projectId),s=encodeURIComponent(this.databaseId.database);this.Mt=t+"://"+e.host,this.Nt=`projects/${r}/databases/${s}`,this.Lt=this.databaseId.database===ra?`project_id=${r}`:`project_id=${r}&database_id=${s}`}Bt(e,t,r,s,i){const o=uc(),l=this.Ut(e,t.toUriEncodedString());j(Ll,`Sending RPC '${e}' ${o}:`,l,r);const c={"google-cloud-resource-prefix":this.Nt,"x-goog-request-params":this.Lt};this.kt(c,s,i);const{host:h}=new URL(l),p=Ur(h);return this.qt(e,l,c,r,p).then(g=>(j(Ll,`Received RPC '${e}' ${o}: `,g),g),g=>{throw zt(Ll,`RPC '${e}' ${o} failed with error: `,g,"url: ",l,"request:",r),g})}$t(e,t,r,s,i,o){return this.Bt(e,t,r,s,i)}kt(e,t,r){e["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+Es}(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach((s,i)=>e[i]=s),r&&r.headers.forEach((s,i)=>e[i]=s)}Ut(e,t){const r=o9[e];let s=`${this.Mt}/v1/${t}:${r}`;return this.databaseInfo.apiKey&&(s=`${s}?key=${encodeURIComponent(this.databaseInfo.apiKey)}`),s}terminate(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rt="WebChannelConnection",Js=(n,e,t)=>{n.listen(e,r=>{try{t(r)}catch(s){setTimeout(()=>{throw s},0)}})};class us extends a9{constructor(e){super(e),this.nn=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}static rn(){if(!us.sn){const e=X2();Js(e,Q2.STAT_EVENT,t=>{t.stat===ec.PROXY?j(rt,"STAT_EVENT: detected buffering proxy"):t.stat===ec.NOPROXY&&j(rt,"STAT_EVENT: detected no buffering proxy")}),us.sn=!0}}qt(e,t,r,s,i){const o=uc();return new Promise((l,c)=>{const h=new K2;h.setWithCredentials(!0),h.listenOnce(Y2.COMPLETE,()=>{try{switch(h.getLastErrorCode()){case Bo.NO_ERROR:const g=h.getResponseJson();j(rt,`XHR for RPC '${e}' ${o} received:`,JSON.stringify(g)),l(g);break;case Bo.TIMEOUT:j(rt,`RPC '${e}' ${o} timed out`),c(new z(V.DEADLINE_EXCEEDED,"Request time out"));break;case Bo.HTTP_ERROR:const x=h.getStatus();if(j(rt,`RPC '${e}' ${o} failed with status:`,x,"response text:",h.getResponseText()),x>0){let R=h.getResponseJson();Array.isArray(R)&&(R=R[0]);const S=R==null?void 0:R.error;if(S&&S.status&&S.message){const B=function(Q){const re=Q.toLowerCase().replace(/_/g,"-");return Object.values(V).indexOf(re)>=0?re:V.UNKNOWN}(S.status);c(new z(B,S.message))}else c(new z(V.UNKNOWN,"Server responded with status "+h.getStatus()))}else c(new z(V.UNAVAILABLE,"Connection failed."));break;default:J(9055,{_n:e,streamId:o,an:h.getLastErrorCode(),un:h.getLastError()})}}finally{j(rt,`RPC '${e}' ${o} completed.`)}});const p=JSON.stringify(s);j(rt,`RPC '${e}' ${o} sending request:`,s),h.send(t,"POST",p,r,15)})}cn(e,t,r){const s=uc(),i=[this.Mt,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=this.createWebChannelTransport(),l={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},c=this.longPollingOptions.timeoutSeconds;c!==void 0&&(l.longPollingTimeout=Math.round(1e3*c)),this.useFetchStreams&&(l.useFetchStreams=!0),this.kt(l.initMessageHeaders,t,r),l.encodeInitMessageHeaders=!0;const h=i.join("");j(rt,`Creating RPC '${e}' stream ${s}: ${h}`,l);const p=o.createWebChannel(h,l);this.En(p);let g=!1,x=!1;const R=new l9({Kt:S=>{x?j(rt,`Not sending because RPC '${e}' stream ${s} is closed:`,S):(g||(j(rt,`Opening RPC '${e}' stream ${s} transport.`),p.open(),g=!0),j(rt,`RPC '${e}' stream ${s} sending:`,S),p.send(S))},Wt:()=>p.close()});return Js(p,ni.EventType.OPEN,()=>{x||(j(rt,`RPC '${e}' stream ${s} transport opened.`),R.Zt())}),Js(p,ni.EventType.CLOSE,()=>{x||(x=!0,j(rt,`RPC '${e}' stream ${s} transport closed`),R.en(),this.hn(p))}),Js(p,ni.EventType.ERROR,S=>{x||(x=!0,zt(rt,`RPC '${e}' stream ${s} transport errored. Name:`,S.name,"Message:",S.message),R.en(new z(V.UNAVAILABLE,"The operation could not be completed")))}),Js(p,ni.EventType.MESSAGE,S=>{var B;if(!x){const U=S.data[0];W(!!U,16349);const Q=U,re=(Q==null?void 0:Q.error)||((B=Q[0])==null?void 0:B.error);if(re){j(rt,`RPC '${e}' stream ${s} received error:`,re);const ue=re.status;let pe=function(A){const y=Be[A];if(y!==void 0)return Sf(y)}(ue),F=re.message;ue==="NOT_FOUND"&&F.includes("database")&&F.includes("does not exist")&&F.includes(this.databaseId.database)&&zt(`Database '${this.databaseId.database}' not found. Please check your project configuration.`),pe===void 0&&(pe=V.INTERNAL,F="Unknown error status: "+ue+" with message "+re.message),x=!0,R.en(new z(pe,F)),p.close()}else j(rt,`RPC '${e}' stream ${s} received:`,U),R.tn(U)}}),us.rn(),setTimeout(()=>{R.Xt()},0),R}terminate(){this.nn.forEach(e=>e.close()),this.nn=[]}En(e){this.nn.push(e)}hn(e){this.nn=this.nn.filter(t=>t===e)}kt(e,t,r){super.kt(e,t,r),this.databaseInfo.apiKey&&(e["x-goog-api-key"]=this.databaseInfo.apiKey)}createWebChannelTransport(){return J2()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lt{constructor(e){this.optionsProto=void 0,{rawOptions:this.rawOptions,...this.knownOptions}=e}_readUserData(e){this.optionsProto=this._optionsUtil.getOptionsProto(e,this.knownOptions,this.rawOptions)}_toProto(e){return{name:this._name,options:this.optionsProto}}}class i0 extends Lt{get _name(){return"add_fields"}get _optionsUtil(){return new ut({})}constructor(e,t){super(t),this.fields=e}_toProto(e){return{...super._toProto(e),args:[ki(e,this.fields)]}}_readUserData(e){super._readUserData(e),lr(this.fields,e)}}class o0 extends Lt{get _name(){return"aggregate"}get _optionsUtil(){return new ut({})}constructor(e,t,r){super(r),this.groups=e,this.accumulators=t}_toProto(e){return{...super._toProto(e),args:[ki(e,this.accumulators),ki(e,this.groups)]}}_readUserData(e){super._readUserData(e),lr(this.groups,e),lr(this.accumulators,e)}}class a0 extends Lt{get _name(){return"distinct"}get _optionsUtil(){return new ut({})}constructor(e,t){super(t),this.groups=e}_toProto(e){return{...super._toProto(e),args:[ki(e,this.groups)]}}_readUserData(e){super._readUserData(e),lr(this.groups,e)}}class qa extends Lt{get _name(){return"collection"}get _optionsUtil(){return new ut({forceIndex:{serverName:"force_index"}})}constructor(e,t){super(t),this.Vr=e.startsWith("/")?e:"/"+e}_toProto(e){return{...super._toProto(e),args:[{referenceValue:this.Vr}]}}_readUserData(e){super._readUserData(e)}}class za extends Lt{get _name(){return"collection_group"}get _optionsUtil(){return new ut({forceIndex:{serverName:"force_index"}})}constructor(e,t){super(t),this.collectionId=e}_toProto(e){return{...super._toProto(e),args:[{referenceValue:""},{stringValue:this.collectionId}]}}_readUserData(e){super._readUserData(e)}}class Jc extends Lt{get _name(){return"database"}get _optionsUtil(){return new ut({})}_toProto(e){return{...super._toProto(e)}}_readUserData(e){super._readUserData(e)}}class Zc extends Lt{get _name(){return"documents"}get _optionsUtil(){return new ut({})}constructor(e,t){if(super(t),!e||e.length===0)throw new z(V.INVALID_ARGUMENT,"Empty document paths are not allowed in DocumentsSource");const r=e.map(i=>i.startsWith("/")?i:"/"+i),s=new Set(r);if(s.size!==r.length)throw new z(V.INVALID_ARGUMENT,"Duplicate document paths are not allowed in DocumentsSource");this.dr=r,this.mr=s}_toProto(e){return{...super._toProto(e),args:this.dr.map(t=>({referenceValue:t}))}}_readUserData(e){super._readUserData(e)}}class Ga extends Lt{get _name(){return"where"}get _optionsUtil(){return new ut({})}constructor(e,t){super(t),this.condition=e}_toProto(e){return{...super._toProto(e),args:[this.condition._toProto(e)]}}_readUserData(e){super._readUserData(e),lr(this.condition,e)}}class Mr extends Lt{get _name(){return"limit"}get _optionsUtil(){return new ut({})}constructor(e,t){W(!isNaN(e)&&e!==1/0&&e!==-1/0,34860),super(t),this.limit=e}_toProto(e){return{...super._toProto(e),args:[$c(e,this.limit)]}}}class yd extends Lt{get _name(){return"offset"}get _optionsUtil(){return new ut({})}constructor(e,t){super(t),this.offset=e}_toProto(e){return{...super._toProto(e),args:[$c(e,this.offset)]}}}class $9 extends Lt{get _name(){return"select"}get _optionsUtil(){return new ut({})}constructor(e,t){super(t),this.selections=e}_toProto(e){return{...super._toProto(e),args:[ki(e,this.selections)]}}_readUserData(e){super._readUserData(e),lr(this.selections,e)}}class mn extends Lt{get _name(){return"sort"}get _optionsUtil(){return new ut({})}constructor(e,t){super(t),this.orderings=e}_toProto(e){return{...super._toProto(e),args:this.orderings.map(t=>t._toProto(e))}}_readUserData(e){super._readUserData(e),lr(this.orderings,e)}}class eu extends Lt{get _name(){return"replace_with"}get _optionsUtil(){return new ut({})}constructor(e,t){super(t),this.map=e}_toProto(e){return{...super._toProto(e),args:[this.map._toProto(e),jf(eu.pr)]}}_readUserData(e){super._readUserData(e),lr(this.map,e)}}eu.pr="full_replace";function lr(n,e){return e0(n)?n._readUserData(e):Array.isArray(n)?n.forEach(t=>t._readUserData(e)):n instanceof Map?n.forEach(t=>t._readUserData(e)):Object.values(n).forEach(t=>t._readUserData(e)),n}// Copyright 2024 Google LLC* @license
class gt{constructor(e,t,r){this.serializer=e,this.stages=t,this.listenOptions=r,this.isCorePipeline=!0}getPipelineCollection(){return Wa(this)}getPipelineCollectionGroup(){return tu(this)}getPipelineCollectionId(){return H9(this)}getPipelineDocuments(){return hc(this)}getPipelineFlavor(){return function(t){let r="exact";return t.stages.forEach((s,i)=>{s._name!==a0.name&&s._name!==o0.name||(r="keyless"),s._name===$9.name&&r==="exact"&&(r="augmented"),s._name===i0.name&&i<t.stages.length-1&&r==="exact"&&(r="augmented")}),r}(this)}getPipelineSourceType(){return Xn(this)}}function Xn(n){const e=n.stages[0];return e instanceof qa||e instanceof za||e instanceof Jc||e instanceof Zc?e._name:"unknown"}function Wa(n){if(Xn(n)==="collection")return n.stages[0].Vr}function tu(n){if(Xn(n)==="collection_group")return n.stages[0].collectionId}function H9(n){switch(Xn(n)){case"collection":return ve.fromString(Wa(n)).lastSegment();case"collection_group":return tu(n);default:return}}function hc(n){if(Xn(n)==="documents")return n.stages[0].dr}class mi{constructor(e,t,r,s){this._db=e,this.userDataReader=t,this._userDataWriter=r,this.stages=s}wr(e,t){const r=this.userDataReader.createContext(3,e);return e0(t)?t._readUserData(r):Array.isArray(t)?t.forEach(s=>s._readUserData(r)):t.forEach(s=>s._readUserData(r)),t}where(e){const t=this.stages.map(r=>r);return this.wr("where",e),t.push(new Ga(e,{})),new mi(this._db,this.userDataReader,this._userDataWriter,t)}limit(e){const t=this.stages.map(r=>r);return t.push(new Mr(e,{})),new mi(this._db,this.userDataReader,this._userDataWriter,t)}sort(e,...t){const r=this.stages.map(s=>s);return"orderings"in e?r.push(new mn(this.wr("sort",e.orderings),{})):r.push(new mn(this.wr("sort",[e,...t]),{})),new mi(this._db,this.userDataReader,this._userDataWriter,r)}br(e){return{pipeline:{stages:this.stages.map(t=>t._toProto(e))}}}}// Copyright 2024 Google LLC* @license
class I{constructor(e,t){this.type=e,this.value=t}static vr(){return new I("ERROR",void 0)}static Sr(){return new I("UNSET",void 0)}static Dr(){return new I("NULL",ms)}static newValue(e){return Ot(e)?new I("NULL",ms):function(r){return!!r&&"booleanValue"in r}(e)?new I("BOOLEAN",e):Xt(e)?new I("INT",e):Ir(e)?new I("DOUBLE",e):function(r){return!!r&&"timestampValue"in r&&!!r.timestampValue}(e)?new I("TIMESTAMP",e):function(r){return!!r&&"stringValue"in r}(e)?new I("STRING",e):function(r){return!!r&&"bytesValue"in r}(e)?new I("BYTES",e):e.referenceValue?new I("REFERENCE",e):e.geoPointValue?new I("GEO_POINT",e):ws(e)?new I("ARRAY",e):sa(e)?new I("VECTOR",e):Cr(e)?new I("MAP",e):new I("ERROR",void 0)}Cr(){return this.type==="ERROR"||this.type==="UNSET"}Fr(){return this.type==="NULL"}}function gi(n){if(!n.Cr())return n.value}function l0(n){return n instanceof ar?n._expr:n}function Z(n){if((n=l0(n))instanceof xs)return new j9(n);if(n instanceof Is)return new q9(n);if(n instanceof si)return new z9(n);if(n instanceof N){if(n.name==="add")return new K9(n);if(n.name==="subtract")return new Y9(n);if(n.name==="multiply")return new Q9(n);if(n.name==="divide")return new X9(n);if(n.name==="mod")return new J9(n);if(n.name==="and")return new Z9(n);if(n.name==="equal")return new h8(n);if(n.name==="not_equal")return new d8(n);if(n.name==="less_than")return new f8(n);if(n.name==="less_than_or_equal")return new p8(n);if(n.name==="greater_than")return new m8(n);if(n.name==="greater_than_or_equal")return new g8(n);if(n.name==="array_concat")return new w8(n);if(n.name==="array_reverse")return new _8(n);if(n.name==="array_contains")return new b8(n);if(n.name==="array_contains_all")return new y8(n);if(n.name==="array_contains_any")return new v8(n);if(n.name==="array_length")return new E8(n);if(n.name==="array_element")return new A8(n);if(n.name==="equal_any")return new c0(n);if(n.name==="not_equal_any")return new t8(n);if(n.name==="is_nan")return new n8(n);if(n.name==="is_not_nan")return new r8(n);if(n.name==="is_null")return new s8(n);if(n.name==="is_not_null")return new i8(n);if(n.name==="is_error")return new o8(n);if(n.name==="exists")return new a8(n);if(n.name==="not")return new Ka(n);if(n.name==="or")return new e8(n);if(n.name==="xor")return new nu(n);if(n.name==="conditional")return new l8(n);if(n.name==="maximum")return new c8(n);if(n.name==="minimum")return new u8(n);if(n.name==="reverse")return new T8(n);if(n.name==="replace_first")return new x8(n);if(n.name==="replace_all")return new I8(n);if(n.name==="char_length")return new C8(n);if(n.name==="byte_length")return new R8(n);if(n.name==="like")return new S8(n);if(n.name==="regex_contains")return new P8(n);if(n.name==="regex_match")return new k8(n);if(n.name==="string_contains")return new O8(n);if(n.name==="starts_with")return new N8(n);if(n.name==="ends_with")return new D8(n);if(n.name==="to_lower")return new L8(n);if(n.name==="to_upper")return new V8(n);if(n.name==="trim")return new M8(n);if(n.name==="string_concat")return new B8(n);if(n.name==="map_get")return new F8(n);if(n.name==="cosine_distance")return new U8(n);if(n.name==="dot_product")return new $8(n);if(n.name==="euclidean_distance")return new H8(n);if(n.name==="vector_length")return new j8(n);if(n.name==="unix_micros_to_timestamp")return new K8(n);if(n.name==="timestamp_to_unix_micros")return new X8(n);if(n.name==="unix_millis_to_timestamp")return new Y8(n);if(n.name==="timestamp_to_unix_millis")return new J8(n);if(n.name==="unix_seconds_to_timestamp")return new Q8(n);if(n.name==="timestamp_to_unix_seconds")return new Z8(n);if(n.name==="timestamp_add")return new e5(n);if(n.name==="timestamp_subtract")return new t5(n)}throw new Error(`Unknown Expr : ${n}`)}class j9{constructor(e){this.expr=e}evaluate(e,t){if(this.expr.fieldName===Qt)return I.newValue({referenceValue:da(e.serializer,t.key)});if(this.expr.fieldName==="__update_time__")return I.newValue({timestampValue:Ho(e.serializer,t.version)});if(this.expr.fieldName==="__create_time__")return I.newValue({timestampValue:Ho(e.serializer,t.createTime)});const r=t.data.field(this.expr._fieldPath);return r?Da(r)?I.newValue(function(i,o){if(i.serverTimestampBehavior==="estimate")return{timestampValue:Ho(i.serializer,se.fromTimestamp(ps(o)))};if(i.serverTimestampBehavior==="previous"){const l=Wi(o);if(l)return l}return{nullValue:"NULL_VALUE"}}(e,r)):I.newValue(r):I.Sr()}}class q9{constructor(e){this.expr=e}evaluate(e,t){return I.newValue(this.expr._getValue())}}class z9{constructor(e){this.expr=e}evaluate(e,t){const r=this.expr.Rr.map(s=>Z(s).evaluate(e,t));return r.some(s=>s.Cr())?I.vr():I.newValue({arrayValue:{values:r.map(s=>s.value)}})}}function tt(n){return Ir(n)?Number(n.doubleValue):Number(n.integerValue)}function ln(n){return BigInt(n.integerValue)}const G9=BigInt("0x7fffffffffffffff"),W9=-BigInt("0x8000000000000000");class Xi{constructor(e){this.expr=e}evaluate(e,t){W(this.expr.params.length>=2,24778);const r=Z(this.expr.params[0]).evaluate(e,t),s=Z(this.expr.params[1]).evaluate(e,t);let i=this.Or(r,s);for(const o of this.expr.params.slice(2)){const l=Z(o).evaluate(e,t);i=this.Or(i,l)}return i}Or(e,t){if(e.Cr()||t.Cr())return I.vr();if(e.Fr()||t.Fr())return I.Dr();const r=e.value,s=t.value;if(!Ir(r)&&!Xt(r)||!Ir(s)&&!Xt(s))return I.vr();if(Ir(r)||Ir(s)){const i=this.Mr(r,s);return i?I.newValue(i):I.vr()}if(Xt(r)&&Xt(s)){const i=this.Nr(r,s);return i===void 0?I.vr():typeof i=="number"?I.newValue({doubleValue:i}):i<W9||i>G9?I.vr():I.newValue({integerValue:`${i}`})}return I.vr()}}function xn(n,e){return qe(n)!==qe(e)?"TYPE_MISMATCH":It(n)||It(e)?"NOT_EQ":Ot(n)&&Ot(e)?"EQ":Ot(n)||Ot(e)?"NULL":ws(n)&&ws(e)?function(r,s){var o,l,c;if(((o=r.values)==null?void 0:o.length)!==((l=s.values)==null?void 0:l.length))return"NOT_EQ";let i=!1;for(let h=0;h<(((c=r.values)==null?void 0:c.length)??0);h++){const p=r.values[h],g=s.values[h];switch(xn(p,g)){case"EQ":break;case"NOT_EQ":case"TYPE_MISMATCH":return"NOT_EQ";case"NULL":i=!0;break;default:J(44609,{Lr:p,Br:g})}}return i?"NULL":"EQ"}(n.arrayValue,e.arrayValue):sa(n)&&sa(e)||Cr(n)&&Cr(e)?function(r,s){const i=r.fields||{},o=s.fields||{};if(na(i)!==na(o))return"NOT_EQ";let l=!1;for(const c in i)if(i.hasOwnProperty(c)){if(o[c]===void 0)return"NOT_EQ";switch(xn(i[c],o[c])){case"NOT_EQ":case"TYPE_MISMATCH":return"NOT_EQ";case"NULL":l=!0}}return l?"NULL":"EQ"}(n.mapValue,e.mapValue):function(r,s){return Ft(r,s,{Te:!1,Ee:!0,he:!0})}(n,e)?"EQ":"NOT_EQ"}class K9 extends Xi{Nr(e,t){return ln(e)+ln(t)}Mr(e,t){return{doubleValue:tt(e)+tt(t)}}}class Y9 extends Xi{constructor(e){super(e),this.expr=e}Nr(e,t){return ln(e)-ln(t)}Mr(e,t){return{doubleValue:tt(e)-tt(t)}}}class Q9 extends Xi{constructor(e){super(e),this.expr=e}Nr(e,t){return ln(e)*ln(t)}Mr(e,t){return{doubleValue:tt(e)*tt(t)}}}class X9 extends Xi{constructor(e){super(e),this.expr=e}Nr(e,t){const r=ln(t);if(r!==BigInt(0))return ln(e)/r}Mr(e,t){const r=tt(t);return r===0?{doubleValue:Ti(r)?Number.NEGATIVE_INFINITY:Number.POSITIVE_INFINITY}:{doubleValue:tt(e)/r}}}class J9 extends Xi{constructor(e){super(e),this.expr=e}Nr(e,t){const r=ln(t);if(r!==BigInt(0))return ln(e)%r}Mr(e,t){const r=tt(t);if(r!==0)return{doubleValue:tt(e)%r}}}class Z9{constructor(e){this.expr=e}evaluate(e,t){var i;let r=!1,s=!1;for(const o of this.expr.params){const l=Z(o).evaluate(e,t);switch(l.type){case"BOOLEAN":if(!((i=l.value)!=null&&i.booleanValue))return I.newValue(Je);break;case"NULL":s=!0;break;default:r=!0}}return r?I.vr():s?I.Dr():I.newValue(Tt)}}class Ka{constructor(e){this.expr=e}evaluate(e,t){var s;W(this.expr.params.length===1,9634);const r=Z(this.expr.params[0]).evaluate(e,t);switch(r.type){case"BOOLEAN":return I.newValue({booleanValue:!((s=r.value)!=null&&s.booleanValue)});case"NULL":return I.Dr();default:return I.vr()}}}class e8{constructor(e){this.expr=e}evaluate(e,t){var i;let r=!1,s=!1;for(const o of this.expr.params){const l=Z(o).evaluate(e,t);switch(l.type){case"BOOLEAN":if((i=l.value)!=null&&i.booleanValue)return I.newValue(Tt);break;case"NULL":s=!0;break;default:r=!0}}return r?I.vr():s?I.Dr():I.newValue(Je)}}class nu{constructor(e){this.expr=e}evaluate(e,t){var i;let r=!1,s=!1;for(const o of this.expr.params){const l=Z(o).evaluate(e,t);switch(l.type){case"BOOLEAN":r=nu.xor(r,!!((i=l.value)!=null&&i.booleanValue));break;case"NULL":s=!0;break;default:return I.vr()}}return s?I.Dr():I.newValue({booleanValue:r})}static xor(e,t){return(e||t)&&!(e&&t)}}class c0{constructor(e){this.expr=e}evaluate(e,t){var o,l;W(this.expr.params.length===2,55094);let r=!1;const s=Z(this.expr.params[0]).evaluate(e,t);switch(s.type){case"NULL":r=!0;break;case"ERROR":case"UNSET":return I.vr()}const i=Z(this.expr.params[1]).evaluate(e,t);switch(i.type){case"ARRAY":break;case"NULL":r=!0;break;default:return I.vr()}if(r)return I.Dr();for(const c of((l=(o=i.value)==null?void 0:o.arrayValue)==null?void 0:l.values)??[])switch(Ot(s.value)&&Ot(c)?"EQ":xn(s.value,c)){case"EQ":return I.newValue(Tt);case"NOT_EQ":case"TYPE_MISMATCH":break;case"NULL":r=!0;break;default:J(44608,{value:s.value,candidate:c})}return r?I.Dr():I.newValue(Je)}}class t8{constructor(e){this.expr=e}evaluate(e,t){return new Ka(new N("not",[new N("equal_any",this.expr.params)])).evaluate(e,t)}}class n8{constructor(e){this.expr=e}evaluate(e,t){W(this.expr.params.length===1,23322);const r=Z(this.expr.params[0]).evaluate(e,t);switch(r.type){case"INT":return I.newValue(Je);case"DOUBLE":return I.newValue({booleanValue:isNaN(tt(r.value))});case"NULL":return I.Dr();default:return I.vr()}}}class r8{constructor(e){this.expr=e}evaluate(e,t){return W(this.expr.params.length===1,50406),new Ka(new N("not",[new N("is_nan",this.expr.params)])).evaluate(e,t)}}class s8{constructor(e){this.expr=e}evaluate(e,t){switch(W(this.expr.params.length===1,23123),Z(this.expr.params[0]).evaluate(e,t).type){case"NULL":return I.newValue(Tt);case"UNSET":case"ERROR":return I.vr();default:return I.newValue(Je)}}}class i8{constructor(e){this.expr=e}evaluate(e,t){return W(this.expr.params.length===1,23167),new Ka(new N("not",[new N("is_null",this.expr.params)])).evaluate(e,t)}}class o8{constructor(e){this.expr=e}evaluate(e,t){return W(this.expr.params.length===1,5228),Z(this.expr.params[0]).evaluate(e,t).type==="ERROR"?I.newValue(Tt):I.newValue(Je)}}class a8{constructor(e){this.expr=e}evaluate(e,t){switch(W(this.expr.params.length===1,6877),Z(this.expr.params[0]).evaluate(e,t).type){case"ERROR":return I.vr();case"UNSET":return I.newValue(Je);default:return I.newValue(Tt)}}}class l8{constructor(e){this.expr=e}evaluate(e,t){var s;W(this.expr.params.length===3,11706);const r=Z(this.expr.params[0]).evaluate(e,t);switch(r.type){case"BOOLEAN":return(s=r.value)!=null&&s.booleanValue?Z(this.expr.params[1]).evaluate(e,t):Z(this.expr.params[2]).evaluate(e,t);case"NULL":return Z(this.expr.params[2]).evaluate(e,t);default:return I.vr()}}}class c8{constructor(e){this.expr=e}evaluate(e,t){const r=this.expr.params.map(i=>Z(i).evaluate(e,t));let s;for(const i of r)switch(i.type){case"ERROR":case"UNSET":case"NULL":continue;default:s=s===void 0||xt(i.value,s.value)>0?i:s}return s===void 0?I.Dr():s}}class u8{constructor(e){this.expr=e}evaluate(e,t){const r=this.expr.params.map(i=>Z(i).evaluate(e,t));let s;for(const i of r)switch(i.type){case"ERROR":case"UNSET":case"NULL":continue;default:s=s===void 0||xt(i.value,s.value)<0?i:s}return s===void 0?I.Dr():s}}class Cs{constructor(e){this.expr=e}evaluate(e,t){W(this.expr.params.length===2,31033,`${this.expr.name}() function should have exactly 2 params`);const r=Z(this.expr.params[0]).evaluate(e,t);switch(r.type){case"ERROR":case"UNSET":return I.vr()}const s=Z(this.expr.params[1]).evaluate(e,t);switch(s.type){case"ERROR":case"UNSET":return I.vr()}return this.Ur(r,s)}}class h8 extends Cs{constructor(e){super(e),this.expr=e}Ur(e,t){if(e.Fr()&&t.Fr())return I.newValue(Tt);if(e.Fr()||t.Fr()||It(e.value)||It(t.value)||qe(e.value)!==qe(t.value))return I.newValue(Je);switch(xn(e.value,t.value)){case"EQ":return I.newValue(Tt);case"NOT_EQ":return I.newValue(Je);case"NULL":return I.Dr();default:J(44615,{left:e,right:t})}}}class d8 extends Cs{constructor(e){super(e),this.expr=e}Ur(e,t){switch(xn(e.value,t.value)){case"EQ":return I.newValue(Je);case"NOT_EQ":case"TYPE_MISMATCH":return I.newValue(Tt);case"NULL":return I.Dr();default:J(44614,{left:e,right:t})}}}class f8 extends Cs{constructor(e){super(e),this.expr=e}Ur(e,t){return qe(e.value)!==qe(t.value)||It(e.value)||It(t.value)?I.newValue(Je):I.newValue({booleanValue:xt(e.value,t.value)<0})}}class p8 extends Cs{constructor(e){super(e),this.expr=e}Ur(e,t){return qe(e.value)!==qe(t.value)||It(e.value)||It(t.value)?I.newValue(Je):xn(e.value,t.value)==="EQ"?I.newValue(Tt):I.newValue({booleanValue:xt(e.value,t.value)<0})}}class m8 extends Cs{constructor(e){super(e),this.expr=e}Ur(e,t){return qe(e.value)!==qe(t.value)||It(e.value)||It(t.value)?I.newValue(Je):I.newValue({booleanValue:xt(e.value,t.value)>0})}}class g8 extends Cs{constructor(e){super(e),this.expr=e}Ur(e,t){return qe(e.value)!==qe(t.value)||It(e.value)||It(t.value)?I.newValue(Je):xn(e.value,t.value)==="EQ"?I.newValue(Tt):I.newValue({booleanValue:xt(e.value,t.value)>0})}}class w8{constructor(e){this.expr=e}evaluate(e,t){throw new Error("Unimplemented")}}class _8{constructor(e){this.expr=e}evaluate(e,t){var s;W(this.expr.params.length===1,216);const r=Z(this.expr.params[0]).evaluate(e,t);switch(r.type){case"NULL":return I.Dr();case"ARRAY":{const i=((s=r.value.arrayValue)==null?void 0:s.values)??[];return I.newValue({arrayValue:{values:[...i].reverse()}})}default:return I.vr()}}}class b8{constructor(e){this.expr=e}evaluate(e,t){return W(this.expr.params.length===2,52884),new c0(new N("eq_any",[this.expr.params[1],this.expr.params[0]])).evaluate(e,t)}}class y8{constructor(e){this.expr=e}evaluate(e,t){var c,h,p,g;W(this.expr.params.length===2,1392);let r=!1;const s=Z(this.expr.params[0]).evaluate(e,t);switch(s.type){case"ARRAY":break;case"NULL":r=!0;break;default:return I.vr()}const i=Z(this.expr.params[1]).evaluate(e,t);switch(i.type){case"ARRAY":break;case"NULL":r=!0;break;default:return I.vr()}if(r)return I.Dr();const o=((h=(c=i.value)==null?void 0:c.arrayValue)==null?void 0:h.values)??[],l=((g=(p=s.value)==null?void 0:p.arrayValue)==null?void 0:g.values)??[];for(const x of o){let R=!1;r=!1;for(const S of l){switch(Ot(x)&&Ot(S)?"EQ":xn(x,S)){case"EQ":R=!0;break;case"NOT_EQ":case"TYPE_MISMATCH":break;case"NULL":r=!0;break;default:J(44613,{value:S,search:x})}if(R)break}if(!R)return I.newValue(Je)}return I.newValue(Tt)}}class v8{constructor(e){this.expr=e}evaluate(e,t){var c,h,p,g;W(this.expr.params.length===2,2680);let r=!1;const s=Z(this.expr.params[0]).evaluate(e,t);switch(s.type){case"ARRAY":break;case"NULL":r=!0;break;default:return I.vr()}const i=Z(this.expr.params[1]).evaluate(e,t);switch(i.type){case"ARRAY":break;case"NULL":r=!0;break;default:return I.vr()}if(r)return I.Dr();const o=((h=(c=i.value)==null?void 0:c.arrayValue)==null?void 0:h.values)??[],l=((g=(p=s.value)==null?void 0:p.arrayValue)==null?void 0:g.values)??[];for(const x of l)for(const R of o)switch(Ot(x)&&Ot(R)?"EQ":xn(x,R)){case"EQ":return I.newValue(Tt);case"NOT_EQ":case"TYPE_MISMATCH":break;case"NULL":r=!0;break;default:J(44608,{value:x,search:R})}return r?I.Dr():I.newValue(Je)}}class E8{constructor(e){this.expr=e}evaluate(e,t){var s,i,o;W(this.expr.params.length===1,38605);const r=Z(this.expr.params[0]).evaluate(e,t);switch(r.type){case"NULL":return I.Dr();case"ARRAY":return I.newValue({integerValue:`${((o=(i=(s=r.value)==null?void 0:s.arrayValue)==null?void 0:i.values)==null?void 0:o.length)??0}`});default:return I.vr()}}}class A8{constructor(e){this.expr=e}evaluate(e,t){throw new Error("Unimplemented")}}class T8{constructor(e){this.expr=e}evaluate(e,t){var s,i;W(this.expr.params.length===1,1508);const r=Z(this.expr.params[0]).evaluate(e,t);switch(r.type){case"NULL":return I.Dr();case"BYTES":{const o=(s=r.value)==null?void 0:s.bytesValue;if(typeof o=="string"){const l=je.fromBase64String(o).toUint8Array();return l.reverse(),I.newValue({bytesValue:je.fromUint8Array(l).toBase64()})}return I.newValue({bytesValue:new Uint8Array(o).reverse()})}case"STRING":{const o=(i=r.value)==null?void 0:i.stringValue,l=new Intl.__PRIVATE_Segmenter(void 0,{granularity:"grapheme"}).segment(o),c=Array.from(l,h=>h.segment).reverse();return I.newValue({stringValue:c.join("")})}default:return I.vr()}}}class x8{constructor(e){this.expr=e}evaluate(e,t){throw new Error("Unimplemented")}}class I8{constructor(e){this.expr=e}evaluate(e,t){throw new Error("Unimplemented")}}class C8{constructor(e){this.expr=e}evaluate(e,t){W(this.expr.params.length===1,19400);const r=Z(this.expr.params[0]).evaluate(e,t);switch(r.type){case"NULL":return I.Dr();case"STRING":{const s=function(o){let l=0;for(let c=0;c<o.length;c++){const h=o.codePointAt(c);if(h===void 0)return;if(h<=65535)if(h>=55296&&h<=57343)if(h<=56319){const p=o.codePointAt(c+1);p!==void 0&&p>=56320&&p<=57343?(l+=1,c++):l+=1}else l+=1;else l+=1;else{if(!(h<=1114111))return;l+=1,c++}}return l}(r.value.stringValue);return s===void 0?I.vr():I.newValue({integerValue:s})}default:return I.vr()}}}class R8{constructor(e){this.expr=e}evaluate(e,t){var s,i;W(this.expr.params.length===1,8486);const r=Z(this.expr.params[0]).evaluate(e,t);switch(r.type){case"BYTES":{const o=(s=r.value)==null?void 0:s.bytesValue;return typeof o=="string"?I.newValue({integerValue:je.fromBase64String(o).toUint8Array().length}):I.newValue({integerValue:new Uint8Array(o).length})}case"STRING":{const o=function(c){let h=0;for(let p=0;p<c.length;p++){const g=c.codePointAt(p);if(g===void 0)return;if(g>=55296&&g<=57343){if(!(g<=56319))return;{const x=c.codePointAt(p+1);if(x===void 0||!(x>=56320&&x<=57343))return;h+=4,p++}}else if(g<=127)h+=1;else if(g<=2047)h+=2;else if(g<=65535)h+=3;else{if(!(g<=1114111))return;h+=4,p++}}return h}((i=r.value)==null?void 0:i.stringValue);return o===void 0?I.vr():I.newValue({integerValue:o})}case"NULL":return I.Dr();default:return I.vr()}}}class Rs{constructor(e){this.expr=e}evaluate(e,t){var o,l;W(this.expr.params.length===2,39773,`${this.expr.name}() function should have exactly two parameters`);let r=!1;const s=Z(this.expr.params[0]).evaluate(e,t);switch(s.type){case"STRING":break;case"NULL":r=!0;break;default:return I.vr()}const i=Z(this.expr.params[1]).evaluate(e,t);switch(i.type){case"STRING":break;case"NULL":r=!0;break;default:return I.vr()}return r?I.Dr():this.kr((o=s.value)==null?void 0:o.stringValue,(l=i.value)==null?void 0:l.stringValue)}}class S8 extends Rs{kr(e,t){try{const r=function(o){let l="";for(let c=0;c<o.length;c++){const h=o.charAt(c);switch(h){case"_":l+=".";break;case"%":l+=".*";break;case"\\":case".":case"*":case"?":case"+":case"^":case"$":case"|":case"(":case")":case"[":case"]":case"{":case"}":l+="\\"+h;break;default:l+=h}}return"^"+l+"$"}(t),s=Ei.compile(r);return I.newValue({booleanValue:s.matches(e)})}catch(r){return zt(`Invalid LIKE pattern converted to regex: ${t}, returning error. Error: ${r}`),I.vr()}}}class P8 extends Rs{kr(e,t){try{const r=Ei.compile(t);return I.newValue({booleanValue:r.matcher(e).find()})}catch{return zt(`Invalid regex pattern found in regex_contains: ${t}, returning error`),I.vr()}}}class k8 extends Rs{kr(e,t){try{return I.newValue({booleanValue:Ei.compile(t).matches(e)})}catch{return zt(`Invalid regex pattern found in regex_match: ${t}, returning error`),I.vr()}}}class O8 extends Rs{kr(e,t){return I.newValue({booleanValue:e.includes(t)})}}class N8 extends Rs{kr(e,t){return I.newValue({booleanValue:e.startsWith(t)})}}class D8 extends Rs{kr(e,t){return I.newValue({booleanValue:e.endsWith(t)})}}class L8{constructor(e){this.expr=e}evaluate(e,t){var s,i;W(this.expr.params.length===1,29079);const r=Z(this.expr.params[0]).evaluate(e,t);switch(r.type){case"STRING":return I.newValue({stringValue:(i=(s=r.value)==null?void 0:s.stringValue)==null?void 0:i.toLowerCase()});case"NULL":return I.Dr();default:return I.vr()}}}class V8{constructor(e){this.expr=e}evaluate(e,t){var s,i;W(this.expr.params.length===1,60487);const r=Z(this.expr.params[0]).evaluate(e,t);switch(r.type){case"STRING":return I.newValue({stringValue:(i=(s=r.value)==null?void 0:s.stringValue)==null?void 0:i.toUpperCase()});case"NULL":return I.Dr();default:return I.vr()}}}class M8{constructor(e){this.expr=e}evaluate(e,t){var s,i;W(this.expr.params.length===1,28544);const r=Z(this.expr.params[0]).evaluate(e,t);switch(r.type){case"STRING":return I.newValue({stringValue:(i=(s=r.value)==null?void 0:s.stringValue)==null?void 0:i.trim()});case"NULL":return I.Dr();default:return I.vr()}}}class B8{constructor(e){this.expr=e}evaluate(e,t){const r=this.expr.params.map(o=>Z(o).evaluate(e,t));let s="",i=!1;for(const o of r)switch(o.type){case"STRING":s+=o.value.stringValue;break;case"NULL":i=!0;break;default:return I.vr()}return i?I.Dr():I.newValue({stringValue:s})}}class F8{constructor(e){this.expr=e}evaluate(e,t){var o,l,c,h;W(this.expr.params.length===2,4483);const r=Z(this.expr.params[0]).evaluate(e,t);switch(r.type){case"UNSET":return I.Sr();case"MAP":break;default:return I.vr()}const s=Z(this.expr.params[1]).evaluate(e,t);if(s.type!=="STRING")return I.vr();const i=(h=(l=(o=r.value)==null?void 0:o.mapValue)==null?void 0:l.fields)==null?void 0:h[(c=s.value)==null?void 0:c.stringValue];return i===void 0?I.Sr():I.newValue(i)}}class ru{constructor(e){this.expr=e}evaluate(e,t){var h,p;W(this.expr.params.length===2,25231,`${this.expr.name}() function should have exactly 2 params`);let r=!1;const s=Z(this.expr.params[0]).evaluate(e,t);switch(s.type){case"VECTOR":break;case"NULL":r=!0;break;default:return I.vr()}const i=Z(this.expr.params[1]).evaluate(e,t);switch(i.type){case"VECTOR":break;case"NULL":r=!0;break;default:return I.vr()}if(r)return I.Dr();const o=sc(s.value),l=sc(i.value);if(o===void 0||l===void 0||((h=o.values)==null?void 0:h.length)!==((p=l.values)==null?void 0:p.length))return I.vr();const c=this.qr(o,l);return c===void 0||isNaN(c)?I.vr():I.newValue({doubleValue:c})}}class U8 extends ru{qr(e,t){const r=(e==null?void 0:e.values)??[],s=(t==null?void 0:t.values)??[];if(r.length===0)return;let i=0,o=0,l=0;for(let h=0;h<r.length;h++){if(!or(r[h])||!or(s[h]))return;const p=tt(r[h]),g=tt(s[h]);i+=p*g,o+=p*p,l+=g*g}const c=Math.sqrt(o)*Math.sqrt(l);if(c!==0)return 1-Math.max(-1,Math.min(1,i/c))}}class $8 extends ru{qr(e,t){const r=(e==null?void 0:e.values)??[],s=(t==null?void 0:t.values)??[];if(r.length===0)return 0;let i=0;for(let o=0;o<r.length;o++){if(!or(r[o])||!or(s[o]))return;i+=tt(r[o])*tt(s[o])}return i}}class H8 extends ru{qr(e,t){const r=(e==null?void 0:e.values)??[],s=(t==null?void 0:t.values)??[];if(r.length===0)return 0;let i=0;for(let o=0;o<r.length;o++){if(!or(r[o])||!or(s[o]))return;const l=tt(r[o]),c=tt(s[o]);i+=Math.pow(l-c,2)}return Math.sqrt(i)}}class j8{constructor(e){this.expr=e}evaluate(e,t){var s;W(this.expr.params.length===1,39044);const r=Z(this.expr.params[0]).evaluate(e,t);switch(r.type){case"VECTOR":{const i=sc(r.value);return I.newValue({integerValue:((s=i==null?void 0:i.values)==null?void 0:s.length)??0})}case"NULL":return I.Dr();default:return I.vr()}}}const Di=BigInt(-62135596800),Li=BigInt(253402300799),pa=BigInt(1e3),Jn=BigInt(1e6),q8=Di*pa,z8=Li*pa+BigInt(999),G8=Di*Jn,W8=Li*Jn+BigInt(999999);function su(n){return n>=G8&&n<=W8}function u0(n){return n>=Di&&n<=Li}function Vi(n,e){const t=BigInt(n);return!(t<Di||t>Li)&&!(e<0||e>=1e9)&&(t!==Di||e===0)&&!(t===Li&&e>999999999)}function h0(n,e){return e<0?{seconds:n-1,nanos:e+1e9}:{seconds:n,nanos:e}}function iu(n){return BigInt(n.seconds)*Jn+BigInt(Math.trunc(n.nanoseconds/1e3))}class ou{constructor(e){this.expr=e}evaluate(e,t){W(this.expr.params.length===1,49262,`${this.expr.name}() function should have exactly one parameter`);const r=Z(this.expr.params[0]).evaluate(e,t);switch(r.type){case"INT":return this.toTimestamp(BigInt(r.value.integerValue));case"NULL":return I.Dr();default:return I.vr()}}}class K8 extends ou{toTimestamp(e){if(!su(e))return I.vr();let t=Number(e/Jn),r=Number(e%Jn*BigInt(1e3));const s=h0(t,r);return t=s.seconds,r=s.nanos,Vi(t,r)?I.newValue({timestampValue:{seconds:t,nanos:r}}):I.vr()}}class Y8 extends ou{toTimestamp(e){if(!function(o){return o>=q8&&o<=z8}(e))return I.vr();let t=Number(e/pa),r=Number(e%pa*BigInt(1e6));const s=h0(t,r);return t=s.seconds,r=s.nanos,Vi(t,r)?I.newValue({timestampValue:{seconds:t,nanos:r}}):I.vr()}}class Q8 extends ou{toTimestamp(e){if(!u0(e))return I.vr();const t=Number(e);return I.newValue({timestampValue:{seconds:t,nanos:0}})}}class au{constructor(e){this.expr=e}evaluate(e,t){W(this.expr.params.length===1,1265,`${this.expr.name}() function should have exactly one parameter`);const r=Z(this.expr.params[0]).evaluate(e,t);switch(r.type){case"TIMESTAMP":break;case"NULL":return I.Dr();default:return I.vr()}const s=Wc(r.value.timestampValue);return Vi(s.seconds,s.nanoseconds)?this.$r(s):I.vr()}}class X8 extends au{$r(e){const t=iu(e);return su(t)?I.newValue({integerValue:`${t.toString()}`}):I.vr()}}class J8 extends au{$r(e){const t=iu(e),r=t/BigInt(1e3),s=t%BigInt(1e3);return r>BigInt(0)||s===BigInt(0)?I.newValue({integerValue:r.toString()}):I.newValue({integerValue:(r-BigInt(1)).toString()})}}class Z8 extends au{$r(e){const t=BigInt(e.seconds);return u0(t)?I.newValue({integerValue:t.toString()}):I.vr()}}class d0{constructor(e){this.expr=e}evaluate(e,t){W(this.expr.params.length===3,2775,`${this.expr.name}() function should have exactly 3 parameters`);let r=!1;const s=Z(this.expr.params[0]).evaluate(e,t);switch(s.type){case"TIMESTAMP":break;case"NULL":r=!0;break;default:return I.vr()}const i=Z(this.expr.params[1]).evaluate(e,t);let o;switch(i.type){case"STRING":if(o=function(re){switch(re){case"microsecond":return"microsecond";case"millisecond":return"millisecond";case"second":return"second";case"minute":return"minute";case"hour":return"hour";case"day":return"day";default:return}}(i.value.stringValue),o===void 0)return I.vr();break;case"NULL":r=!0;break;default:return I.vr()}const l=Z(this.expr.params[2]).evaluate(e,t);switch(l.type){case"INT":break;case"NULL":r=!0;break;default:return I.vr()}if(r)return I.Dr();const c=BigInt(l.value.integerValue);let h;try{switch(o){case"microsecond":h=c;break;case"millisecond":h=c*BigInt(1e3);break;case"second":h=c*BigInt(1e6);break;case"minute":h=c*BigInt(6e7);break;case"hour":h=c*BigInt(36e8);break;case"day":h=c*BigInt(864e8);break;default:return I.vr()}if(o!=="microsecond"&&c!==BigInt(0)&&h/c!==BigInt(this.Kr(o)))return I.vr()}catch(Q){return zt(`Error during timestamp arithmetic: ${Q}`),I.vr()}const p=Wc(s.value.timestampValue);if(!Vi(p.seconds,p.nanoseconds))return I.vr();const g=iu(p),x=this.Wr(g,h);if(!su(x))return I.vr();const R=Number(x/Jn),S=x%Jn,B=Number((S<0?S+Jn:S)*BigInt(1e3)),U=S<0?R-1:R;return Vi(U,B)?I.newValue({timestampValue:{seconds:U,nanos:B}}):I.vr()}Kr(e){switch(e){case"millisecond":return 1e3;case"second":return 1e6;case"minute":return 6e7;case"hour":return 36e8;case"day":return 864e8;default:return 1}}}class e5 extends d0{Wr(e,t){return e+t}}class t5 extends d0{Wr(e,t){return e-t}}function Mi(n){if((n=l0(n))instanceof xs)return`fld(${n.fieldName})`;if(n instanceof Is)return`cst(${function(t){return t===null?"null":typeof t=="number"?t.toString():typeof t=="string"?`"${t}"`:t instanceof $e?`ref(${t.path})`:t instanceof Et?`vec(${JSON.stringify(t)})`:JSON.stringify(t)}(n.value)})`;if(n instanceof N)return`fn(${n.name},[${n.params.map(Mi).join(",")}])`;if(n.expressionType==="ListOfExpressions")return`list([${n.Rr.map(Mi).join(",")}])`;throw new Error(`Unrecognized expr ${JSON.stringify(n,null,2)}`)}function n5(n){if(n instanceof i0)return`${n._name}(${Ro(n.fields)})`;if(n instanceof o0){let e=`${n._name}(${Ro(n.accumulators)})`;return n.groups.size>0&&(e+=`grouping(${Ro(n.groups)})`),e}if(n instanceof a0)return`${n._name}(${Ro(n.groups)})`;if(n instanceof qa)return`${n._name}(${n.Vr})`;if(n instanceof za)return`${n._name}(${n.collectionId})`;if(n instanceof Jc)return`${n._name}()`;if(n instanceof Zc)return`${n._name}(${n.dr.sort()})`;if(n instanceof Ga)return`${n._name}(${Mi(n.condition)})`;if(n instanceof Mr)return`${n._name}(${n.limit})`;if(n instanceof mn)return`${n._name}(${function(t){return t.map(r=>`${Mi(r.expr)}${r.direction}`).join(",")}(n.orderings)})`;throw new Error(`Unrecognized stage ${n._name}`)}function Ro(n){return`${Array.from(n.entries()).sort().map(([e,t])=>`${e}=${Mi(t)}`).join(",")}`}function yn(n){return n.stages.map(e=>n5(e)).join("|")}function f0(n,e){return yn(n)===yn(e)}function Ke(n){return n instanceof gt}function vd(n){return Ke(n)?yn(n):fi(n)}function p0(n){return Ke(n)?yn(n):function(t){return`${If(rn(t))}|lt:${t.limitType}`}(n)}function Ya(n,e){return n instanceof gt&&e instanceof gt?f0(n,e):!(n instanceof gt&&!(e instanceof gt)||!(n instanceof gt)&&e instanceof gt)&&S3(n,e)}function m0(n){return xr(n)?yn(n):If(n)}function g0(n,e){return n instanceof gt&&e instanceof gt?f0(n,e):!(n instanceof gt&&!(e instanceof gt)||!(n instanceof gt)&&e instanceof gt)&&Cf(n,e)}function r5(n,e){const t=function(s){let i=!1;const o=[];for(const l of s)if(l instanceof mn)if(i=!0,l.orderings.some(c=>c.expr instanceof xs&&c.expr.fieldName===Qt))o.push(l);else{const c=l.orderings.map(h=>h);c.push(jo(Qt).ascending()),o.push(new mn(c,{}))}else l instanceof Mr&&(i||(o.push(new mn([jo(Qt).ascending()],{})),i=!0)),o.push(l);return i||o.push(new mn([jo(Qt).ascending()],{})),o}(n.stages);if(n.userDataReader){const r=n.userDataReader.createContext(3,"toCorePipeline");t.forEach(s=>s._readUserData(r))}return new gt(n.userDataReader.serializer,t,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class d5{constructor(){this.changes=new zr(e=>e.toString(),(e,t)=>e.isEqual(t)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,at.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const r=this.changes.get(t);return r!==void 0?L.resolve(r):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nt{constructor(e,t){this.bucket=e,this.path_=t}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,t){let r;try{r=Nt.makeFromUrl(e,t)}catch{return new Nt(e,"")}if(r.path==="")return r;throw qw(e)}static makeFromUrl(e,t){let r=null;const s="([A-Za-z0-9.\\-_]+)";function i(pe){pe.path.charAt(pe.path.length-1)==="/"&&(pe.path_=pe.path_.slice(0,-1))}const o="(/(.*))?$",l=new RegExp("^gs://"+s+o,"i"),c={bucket:1,path:3};function h(pe){pe.path_=decodeURIComponent(pe.path)}const p="v[A-Za-z0-9_]+",g=t.replace(/[.]/g,"\\."),x="(/([^?#]*).*)?$",R=new RegExp(`^https?://${g}/${p}/b/${s}/o${x}`,"i"),S={bucket:1,path:3},B=t===q0?"(?:storage.googleapis.com|storage.cloud.google.com)":t,U="([^?#]*)",Q=new RegExp(`^https?://${B}/${s}/${U}`,"i"),ue=[{regex:l,indices:c,postModify:i},{regex:R,indices:S,postModify:h},{regex:Q,indices:{bucket:1,path:2},postModify:h}];for(let pe=0;pe<ue.length;pe++){const F=ue[pe],M=F.regex.exec(e);if(M){const A=M[F.indices.bucket];let y=M[F.indices.path];y||(y=""),r=new Nt(A,y),F.postModify(r);break}}if(r==null)throw jw(e);return r}}class Qw{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xw(n,e,t){let r=1,s=null,i=null,o=!1,l=0;function c(){return l===2}let h=!1;function p(...U){h||(h=!0,e.apply(null,U))}function g(U){s=setTimeout(()=>{s=null,n(R,c())},U)}function x(){i&&clearTimeout(i)}function R(U,...Q){if(h){x();return}if(U){x(),p.call(null,U,...Q);return}if(c()||o){x(),p.call(null,U,...Q);return}r<64&&(r*=2);let ue;l===1?(l=2,ue=0):ue=(r+Math.random())*1e3,g(ue)}let S=!1;function B(U){S||(S=!0,x(),!h&&(s!==null?(U||(l=2),clearTimeout(s),g(0)):U||(l=1)))}return g(0),i=setTimeout(()=>{o=!0,B(!0)},t),B}function Jw(n){n(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`).join("<br />")),Tb(n)}let Yt;var No=new WeakMap;class Ve{constructor(...e){if(eb(this,No,Promise.resolve({isConfirmed:!1,isDenied:!1,isDismissed:!0})),typeof window>"u")return;Yt=this;const t=Object.freeze(this.constructor.argsToParams(e));this.params=t,this.isAwaitingPromise=!1,tb(No,this,this._main(Yt.params))}_main(e,t={}){if(Kp(Object.assign({},t,e)),Y.currentInstance){const i=bs.swalPromiseResolve.get(Y.currentInstance),{isAwaitingPromise:o}=Y.currentInstance;Y.currentInstance._destroy(),o||i({isDismissed:!0}),Bu()&&Pp()}Y.currentInstance=Yt;const r=Bv(e,t);Vv(r),Object.freeze(r),Y.timeout&&(Y.timeout.stop(),delete Y.timeout),clearTimeout(Y.restoreFocusTimeout);const s=Fv(Yt);return Ip(Yt,r),Ee.innerParams.set(Yt,r),Mv(Yt,s,r)}then(e){return $d(No,this).then(e)}finally(e){return $d(No,this).finally(e)}}const Mv=(n,e,t)=>new Promise((r,s)=>{const i=o=>{n.close({isDismissed:!0,dismiss:o,isConfirmed:!1,isDenied:!1})};bs.swalPromiseResolve.set(n,r),bs.swalPromiseReject.set(n,s),e.confirmButton.onclick=()=>{Fy(n)},e.denyButton.onclick=()=>{Uy(n)},e.cancelButton.onclick=()=>{$y(n,i)},e.closeButton.onclick=()=>{i(Ns.close)},Zy(t,e,i),oy(Y,t,i),Py(n,t),Pv(t),Uv(Y,t,i),$v(e,t),setTimeout(()=>{e.container.scrollTop=0})}),Bv=(n,e)=>{const t=vv(n),r=Object.assign({},Gn,e,t,n);return r.showClass=Object.assign({},Gn.showClass,r.showClass),r.hideClass=Object.assign({},Gn.hideClass,r.hideClass),r.animation===!1&&(r.showClass={backdrop:"swal2-noanimation"},r.hideClass={}),r},Fv=n=>{const e={popup:be(),container:_t(),actions:ro(),confirmButton:un(),denyButton:Yr(),cancelButton:ks(),loader:Os(),closeButton:Vu(),validationMessage:tl(),progressSteps:Lu()};return Ee.domCache.set(n,e),e},Uv=(n,e,t)=>{const r=nl();ct(r),e.timer&&(n.timeout=new yv(()=>{t("timer"),delete n.timeout},e.timer),e.timerProgressBar&&r&&(Ze(r),Dt(r,e,"timerProgressBar"),setTimeout(()=>{n.timeout&&n.timeout.running&&Uu(e.timer)})))},$v=(n,e)=>{if(!e.toast){if(!el(e.allowEnterKey)){dp("allowEnterKey","preConfirm: () => false"),n.popup.focus();return}Hv(n)||jv(n,e)||vc(-1,1)}},Hv=n=>{const e=Array.from(n.popup.querySelectorAll("[autofocus]"));for(const t of e)if(t instanceof HTMLElement&&At(t))return t.focus(),!0;return!1},jv=(n,e)=>e.focusDeny&&At(n.denyButton)?(n.denyButton.focus(),!0):e.focusCancel&&At(n.cancelButton)?(n.cancelButton.focus(),!0):e.focusConfirm&&At(n.confirmButton)?(n.confirmButton.focus(),!0):!1;Ve.prototype.disableButtons=Up;Ve.prototype.enableButtons=Fp;Ve.prototype.getInput=Vp;Ve.prototype.disableInput=Hp;Ve.prototype.enableInput=$p;Ve.prototype.hideLoading=Aa;Ve.prototype.disableLoading=Aa;Ve.prototype.showValidationMessage=jp;Ve.prototype.resetValidationMessage=qp;Ve.prototype.close=zn;Ve.prototype.closePopup=zn;Ve.prototype.closeModal=zn;Ve.prototype.closeToast=zn;Ve.prototype.rejectPromise=Op;Ve.prototype.update=Yp;Ve.prototype._destroy=Qp;Object.assign(Ve,bv);Object.keys(Jy).forEach(n=>{Ve[n]=function(...e){if(Yt&&Yt[n])return Yt[n](...e)}});Ve.DismissReason=Ns;Ve.version="11.26.25";const ie=Ve;ie.default=ie;typeof document<"u"&&function(n,e){var t=n.createElement("style");if(n.getElementsByTagName("head")[0].appendChild(t),t.styleSheet)t.styleSheet.disabled||(t.styleSheet.cssText=e);else try{t.innerHTML=e}catch{t.innerText=e}}(document,':root{--swal2-outline: 0 0 0 3px rgba(100, 150, 200, 0.5);--swal2-container-padding: 0.625em;--swal2-backdrop: rgba(0, 0, 0, 0.4);--swal2-backdrop-transition: background-color 0.15s;--swal2-width: 32em;--swal2-padding: 0 0 1.25em;--swal2-border: none;--swal2-border-radius: 0.3125rem;--swal2-background: white;--swal2-color: #545454;--swal2-show-animation: swal2-show 0.3s;--swal2-hide-animation: swal2-hide 0.15s forwards;--swal2-icon-zoom: 1;--swal2-title-padding: 0.8em 1em 0;--swal2-html-container-padding: 1em 1.6em 0.3em;--swal2-input-border: 1px solid #d9d9d9;--swal2-input-border-radius: 0.1875em;--swal2-input-box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.06), 0 0 0 3px transparent;--swal2-input-background: transparent;--swal2-input-transition: border-color 0.2s, box-shadow 0.2s;--swal2-input-hover-box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.06), 0 0 0 3px transparent;--swal2-input-focus-border: 1px solid #b4dbed;--swal2-input-focus-box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.06), 0 0 0 3px rgba(100, 150, 200, 0.5);--swal2-progress-step-background: #add8e6;--swal2-validation-message-background: #f0f0f0;--swal2-validation-message-color: #666;--swal2-footer-border-color: #eee;--swal2-footer-background: transparent;--swal2-footer-color: inherit;--swal2-timer-progress-bar-background: rgba(0, 0, 0, 0.3);--swal2-close-button-position: initial;--swal2-close-button-inset: auto;--swal2-close-button-font-size: 2.5em;--swal2-close-button-color: #ccc;--swal2-close-button-transition: color 0.2s, box-shadow 0.2s;--swal2-close-button-outline: initial;--swal2-close-button-box-shadow: inset 0 0 0 3px transparent;--swal2-close-button-focus-box-shadow: inset var(--swal2-outline);--swal2-close-button-hover-transform: none;--swal2-actions-justify-content: center;--swal2-actions-width: auto;--swal2-actions-margin: 1.25em auto 0;--swal2-actions-padding: 0;--swal2-actions-border-radius: 0;--swal2-actions-background: transparent;--swal2-action-button-transition: background-color 0.2s, box-shadow 0.2s;--swal2-action-button-hover: black 10%;--swal2-action-button-active: black 10%;--swal2-confirm-button-box-shadow: none;--swal2-confirm-button-border-radius: 0.25em;--swal2-confirm-button-background-color: #7066e0;--swal2-confirm-button-color: #fff;--swal2-deny-button-box-shadow: none;--swal2-deny-button-border-radius: 0.25em;--swal2-deny-button-background-color: #dc3741;--swal2-deny-button-color: #fff;--swal2-cancel-button-box-shadow: none;--swal2-cancel-button-border-radius: 0.25em;--swal2-cancel-button-background-color: #6e7881;--swal2-cancel-button-color: #fff;--swal2-toast-show-animation: swal2-toast-show 0.5s;--swal2-toast-hide-animation: swal2-toast-hide 0.1s forwards;--swal2-toast-border: none;--swal2-toast-box-shadow: 0 0 1px hsl(0deg 0% 0% / 0.075), 0 1px 2px hsl(0deg 0% 0% / 0.075), 1px 2px 4px hsl(0deg 0% 0% / 0.075), 1px 3px 8px hsl(0deg 0% 0% / 0.075), 2px 4px 16px hsl(0deg 0% 0% / 0.075)}[data-swal2-theme=dark]{--swal2-dark-theme-black: #19191a;--swal2-dark-theme-white: #e1e1e1;--swal2-background: var(--swal2-dark-theme-black);--swal2-color: var(--swal2-dark-theme-white);--swal2-footer-border-color: #555;--swal2-input-background: color-mix(in srgb, var(--swal2-dark-theme-black), var(--swal2-dark-theme-white) 10%);--swal2-validation-message-background: color-mix( in srgb, var(--swal2-dark-theme-black), var(--swal2-dark-theme-white) 10% );--swal2-validation-message-color: var(--swal2-dark-theme-white);--swal2-timer-progress-bar-background: rgba(255, 255, 255, 0.7)}@media(prefers-color-scheme: dark){[data-swal2-theme=auto]{--swal2-dark-theme-black: #19191a;--swal2-dark-theme-white: #e1e1e1;--swal2-background: var(--swal2-dark-theme-black);--swal2-color: var(--swal2-dark-theme-white);--swal2-footer-border-color: #555;--swal2-input-background: color-mix(in srgb, var(--swal2-dark-theme-black), var(--swal2-dark-theme-white) 10%);--swal2-validation-message-background: color-mix( in srgb, var(--swal2-dark-theme-black), var(--swal2-dark-theme-white) 10% );--swal2-validation-message-color: var(--swal2-dark-theme-white);--swal2-timer-progress-bar-background: rgba(255, 255, 255, 0.7)}}body.swal2-shown:not(.swal2-no-backdrop,.swal2-toast-shown){overflow:hidden}body.swal2-height-auto{height:auto !important}body.swal2-no-backdrop .swal2-container{background-color:rgba(0,0,0,0) !important;pointer-events:none}body.swal2-no-backdrop .swal2-container .swal2-popup{pointer-events:auto}body.swal2-no-backdrop .swal2-container .swal2-modal{box-shadow:0 0 10px var(--swal2-backdrop)}body.swal2-toast-shown .swal2-container{box-sizing:border-box;width:360px;max-width:100%;background-color:rgba(0,0,0,0);pointer-events:none}body.swal2-toast-shown .swal2-container.swal2-top{inset:0 auto auto 50%;transform:translateX(-50%)}body.swal2-toast-shown .swal2-container.swal2-top-end,body.swal2-toast-shown .swal2-container.swal2-top-right{inset:0 0 auto auto}body.swal2-toast-shown .swal2-container.swal2-top-start,body.swal2-toast-shown .swal2-container.swal2-top-left{inset:0 auto auto 0}body.swal2-toast-shown .swal2-container.swal2-center-start,body.swal2-toast-shown .swal2-container.swal2-center-left{inset:50% auto auto 0;transform:translateY(-50%)}body.swal2-toast-shown .swal2-container.swal2-center{inset:50% auto auto 50%;transform:translate(-50%, -50%)}body.swal2-toast-shown .swal2-container.swal2-center-end,body.swal2-toast-shown .swal2-container.swal2-center-right{inset:50% 0 auto auto;transform:translateY(-50%)}body.swal2-toast-shown .swal2-container.swal2-bottom-start,body.swal2-toast-shown .swal2-container.swal2-bottom-left{inset:auto auto 0 0}body.swal2-toast-shown .swal2-container.swal2-bottom{inset:auto auto 0 50%;transform:translateX(-50%)}body.swal2-toast-shown .swal2-container.swal2-bottom-end,body.swal2-toast-shown .swal2-container.swal2-bottom-right{inset:auto 0 0 auto}@media print{body.swal2-shown:not(.swal2-no-backdrop,.swal2-toast-shown){overflow-y:scroll !important}body.swal2-shown:not(.swal2-no-backdrop,.swal2-toast-shown)>[aria-hidden=true]{display:none}body.swal2-shown:not(.swal2-no-backdrop,.swal2-toast-shown) .swal2-container{position:static !important}}div:where(.swal2-container){display:grid;position:fixed;z-index:1060;inset:0;box-sizing:border-box;grid-template-areas:"top-start     top            top-end" "center-start  center         center-end" "bottom-start  bottom-center  bottom-end";grid-template-rows:minmax(min-content, auto) minmax(min-content, auto) minmax(min-content, auto);height:100%;padding:var(--swal2-container-padding);overflow-x:hidden;transition:var(--swal2-backdrop-transition);-webkit-overflow-scrolling:touch}div:where(.swal2-container).swal2-backdrop-show,div:where(.swal2-container).swal2-noanimation{background:var(--swal2-backdrop)}div:where(.swal2-container).swal2-backdrop-hide{background:rgba(0,0,0,0) !important}div:where(.swal2-container).swal2-top-start,div:where(.swal2-container).swal2-center-start,div:where(.swal2-container).swal2-bottom-start{grid-template-columns:minmax(0, 1fr) auto auto}div:where(.swal2-container).swal2-top,div:where(.swal2-container).swal2-center,div:where(.swal2-container).swal2-bottom{grid-template-columns:auto minmax(0, 1fr) auto}div:where(.swal2-container).swal2-top-end,div:where(.swal2-container).swal2-center-end,div:where(.swal2-container).swal2-bottom-end{grid-template-columns:auto auto minmax(0, 1fr)}div:where(.swal2-container).swal2-top-start>.swal2-popup{align-self:start}div:where(.swal2-container).swal2-top>.swal2-popup{grid-column:2;place-self:start center}div:where(.swal2-container).swal2-top-end>.swal2-popup,div:where(.swal2-container).swal2-top-right>.swal2-popup{grid-column:3;place-self:start end}div:where(.swal2-container).swal2-center-start>.swal2-popup,div:where(.swal2-container).swal2-center-left>.swal2-popup{grid-row:2;align-self:center}div:where(.swal2-container).swal2-center>.swal2-popup{grid-column:2;grid-row:2;place-self:center center}div:where(.swal2-container).swal2-center-end>.swal2-popup,div:where(.swal2-container).swal2-center-right>.swal2-popup{grid-column:3;grid-row:2;place-self:center end}div:where(.swal2-container).swal2-bottom-start>.swal2-popup,div:where(.swal2-container).swal2-bottom-left>.swal2-popup{grid-column:1;grid-row:3;align-self:end}div:where(.swal2-container).swal2-bottom>.swal2-popup{grid-column:2;grid-row:3;place-self:end center}div:where(.swal2-container).swal2-bottom-end>.swal2-popup,div:where(.swal2-container).swal2-bottom-right>.swal2-popup{grid-column:3;grid-row:3;place-self:end end}div:where(.swal2-container).swal2-grow-row>.swal2-popup,div:where(.swal2-container).swal2-grow-fullscreen>.swal2-popup{grid-column:1/4;width:100%}div:where(.swal2-container).swal2-grow-column>.swal2-popup,div:where(.swal2-container).swal2-grow-fullscreen>.swal2-popup{grid-row:1/4;align-self:stretch}div:where(.swal2-container).swal2-no-transition{transition:none !important}div:where(.swal2-container)[popover]{width:auto;border:0}div:where(.swal2-container) div:where(.swal2-popup){display:none;position:relative;box-sizing:border-box;grid-template-columns:minmax(0, 100%);width:var(--swal2-width);max-width:100%;padding:var(--swal2-padding);border:var(--swal2-border);border-radius:var(--swal2-border-radius);background:var(--swal2-background);color:var(--swal2-color);font-family:inherit;font-size:1rem}div:where(.swal2-container) div:where(.swal2-popup):focus{outline:none}div:where(.swal2-container) div:where(.swal2-popup).swal2-loading{overflow-y:hidden}div:where(.swal2-container) div:where(.swal2-popup).swal2-draggable{cursor:grab}div:where(.swal2-container) div:where(.swal2-popup).swal2-draggable div:where(.swal2-icon){cursor:grab}div:where(.swal2-container) div:where(.swal2-popup).swal2-dragging{cursor:grabbing}div:where(.swal2-container) div:where(.swal2-popup).swal2-dragging div:where(.swal2-icon){cursor:grabbing}div:where(.swal2-container) h2:where(.swal2-title){position:relative;max-width:100%;margin:0;padding:var(--swal2-title-padding);color:inherit;font-size:1.875em;font-weight:600;text-align:center;text-transform:none;overflow-wrap:break-word;cursor:initial}div:where(.swal2-container) div:where(.swal2-actions){display:flex;z-index:1;box-sizing:border-box;flex-wrap:wrap;align-items:center;justify-content:var(--swal2-actions-justify-content);width:var(--swal2-actions-width);margin:var(--swal2-actions-margin);padding:var(--swal2-actions-padding);border-radius:var(--swal2-actions-border-radius);background:var(--swal2-actions-background)}div:where(.swal2-container) div:where(.swal2-loader){display:none;align-items:center;justify-content:center;width:2.2em;height:2.2em;margin:0 1.875em;animation:swal2-rotate-loading 1.5s linear 0s infinite normal;border-width:.25em;border-style:solid;border-radius:100%;border-color:#2778c4 rgba(0,0,0,0) #2778c4 rgba(0,0,0,0)}div:where(.swal2-container) button:where(.swal2-styled){margin:.3125em;padding:.625em 1.1em;transition:var(--swal2-action-button-transition);border:none;box-shadow:0 0 0 3px rgba(0,0,0,0);font-weight:500}div:where(.swal2-container) button:where(.swal2-styled):not([disabled]){cursor:pointer}div:where(.swal2-container) button:where(.swal2-styled):where(.swal2-confirm){border-radius:var(--swal2-confirm-button-border-radius);background:initial;background-color:var(--swal2-confirm-button-background-color);box-shadow:var(--swal2-confirm-button-box-shadow);color:var(--swal2-confirm-button-color);font-size:1em}div:where(.swal2-container) button:where(.swal2-styled):where(.swal2-confirm):hover{background-color:color-mix(in srgb, var(--swal2-confirm-button-background-color), var(--swal2-action-button-hover))}div:where(.swal2-container) button:where(.swal2-styled):where(.swal2-confirm):active{background-color:color-mix(in srgb, var(--swal2-confirm-button-background-color), var(--swal2-action-button-active))}div:where(.swal2-container) button:where(.swal2-styled):where(.swal2-deny){border-radius:var(--swal2-deny-button-border-radius);background:initial;background-color:var(--swal2-deny-button-background-color);box-shadow:var(--swal2-deny-button-box-shadow);color:var(--swal2-deny-button-color);font-size:1em}div:where(.swal2-container) button:where(.swal2-styled):where(.swal2-deny):hover{background-color:color-mix(in srgb, var(--swal2-deny-button-background-color), var(--swal2-action-button-hover))}div:where(.swal2-container) button:where(.swal2-styled):where(.swal2-deny):active{background-color:color-mix(in srgb, var(--swal2-deny-button-background-color), var(--swal2-action-button-active))}div:where(.swal2-container) button:where(.swal2-styled):where(.swal2-cancel){border-radius:var(--swal2-cancel-button-border-radius);background:initial;background-color:var(--swal2-cancel-button-background-color);box-shadow:var(--swal2-cancel-button-box-shadow);color:var(--swal2-cancel-button-color);font-size:1em}div:where(.swal2-container) button:where(.swal2-styled):where(.swal2-cancel):hover{background-color:color-mix(in srgb, var(--swal2-cancel-button-background-color), var(--swal2-action-button-hover))}div:where(.swal2-container) button:where(.swal2-styled):where(.swal2-cancel):active{background-color:color-mix(in srgb, var(--swal2-cancel-button-background-color), var(--swal2-action-button-active))}div:where(.swal2-container) button:where(.swal2-styled):focus-visible{outline:none;box-shadow:var(--swal2-action-button-focus-box-shadow)}div:where(.swal2-container) button:where(.swal2-styled)[disabled]:not(.swal2-loading){opacity:.4}div:where(.swal2-container) button:where(.swal2-styled)::-moz-focus-inner{border:0}div:where(.swal2-container) div:where(.swal2-footer){margin:1em 0 0;padding:1em 1em 0;border-top:1px solid var(--swal2-footer-border-color);background:var(--swal2-footer-background);color:var(--swal2-footer-color);font-size:1em;text-align:center;cursor:initial}div:where(.swal2-container) .swal2-timer-progress-bar-container{position:absolute;right:0;bottom:0;left:0;grid-column:auto !important;overflow:hidden;border-bottom-right-radius:var(--swal2-border-radius);border-bottom-left-radius:var(--swal2-border-radius)}div:where(.swal2-container) div:where(.swal2-timer-progress-bar){width:100%;height:.25em;background:var(--swal2-timer-progress-bar-background)}div:where(.swal2-container) img:where(.swal2-image){max-width:100%;margin:2em auto 1em;cursor:initial}div:where(.swal2-container) button:where(.swal2-close){position:var(--swal2-close-button-position);inset:var(--swal2-close-button-inset);z-index:2;align-items:center;justify-content:center;width:1.2em;height:1.2em;margin-top:0;margin-right:0;margin-bottom:-1.2em;padding:0;overflow:hidden;transition:var(--swal2-close-button-transition);border:none;border-radius:var(--swal2-border-radius);outline:var(--swal2-close-button-outline);background:rgba(0,0,0,0);color:var(--swal2-close-button-color);font-family:monospace;font-size:var(--swal2-close-button-font-size);cursor:pointer;justify-self:end}div:where(.swal2-container) button:where(.swal2-close):hover{transform:var(--swal2-close-button-hover-transform);background:rgba(0,0,0,0);color:#f27474}div:where(.swal2-container) button:where(.swal2-close):focus-visible{outline:none;box-shadow:var(--swal2-close-button-focus-box-shadow)}div:where(.swal2-container) button:where(.swal2-close)::-moz-focus-inner{border:0}div:where(.swal2-container) div:where(.swal2-html-container){z-index:1;justify-content:center;margin:0;padding:var(--swal2-html-container-padding);overflow:auto;color:inherit;font-size:1.125em;font-weight:normal;line-height:normal;text-align:center;overflow-wrap:break-word;word-break:break-word;cursor:initial}div:where(.swal2-container) input:where(.swal2-input),div:where(.swal2-container) input:where(.swal2-file),div:where(.swal2-container) textarea:where(.swal2-textarea),div:where(.swal2-container) select:where(.swal2-select),div:where(.swal2-container) div:where(.swal2-radio),div:where(.swal2-container) label:where(.swal2-checkbox){margin:1em 2em 3px}div:where(.swal2-container) input:where(.swal2-input),div:where(.swal2-container) input:where(.swal2-file),div:where(.swal2-container) textarea:where(.swal2-textarea){box-sizing:border-box;width:auto;transition:var(--swal2-input-transition);border:var(--swal2-input-border);border-radius:var(--swal2-input-border-radius);background:var(--swal2-input-background);box-shadow:var(--swal2-input-box-shadow);color:inherit;font-size:1.125em}div:where(.swal2-container) input:where(.swal2-input).swal2-inputerror,div:where(.swal2-container) input:where(.swal2-file).swal2-inputerror,div:where(.swal2-container) textarea:where(.swal2-textarea).swal2-inputerror{border-color:#f27474 !important;box-shadow:0 0 2px #f27474 !important}div:where(.swal2-container) input:where(.swal2-input):hover,div:where(.swal2-container) input:where(.swal2-file):hover,div:where(.swal2-container) textarea:where(.swal2-textarea):hover{box-shadow:var(--swal2-input-hover-box-shadow)}div:where(.swal2-container) input:where(.swal2-input):focus,div:where(.swal2-container) input:where(.swal2-file):focus,div:where(.swal2-container) textarea:where(.swal2-textarea):focus{border:var(--swal2-input-focus-border);outline:none;box-shadow:var(--swal2-input-focus-box-shadow)}div:where(.swal2-container) input:where(.swal2-input)::placeholder,div:where(.swal2-container) input:where(.swal2-file)::placeholder,div:where(.swal2-container) textarea:where(.swal2-textarea)::placeholder{color:#ccc}div:where(.swal2-container) .swal2-range{margin:1em 2em 3px;background:var(--swal2-background)}div:where(.swal2-container) .swal2-range input{width:80%}div:where(.swal2-container) .swal2-range output{width:20%;color:inherit;font-weight:600;text-align:center}div:where(.swal2-container) .swal2-range input,div:where(.swal2-container) .swal2-range output{height:2.625em;padding:0;font-size:1.125em;line-height:2.625em}div:where(.swal2-container) .swal2-input{height:2.625em;padding:0 .75em}div:where(.swal2-container) .swal2-file{width:75%;margin-right:auto;margin-left:auto;background:var(--swal2-input-background);font-size:1.125em}div:where(.swal2-container) .swal2-textarea{height:6.75em;padding:.75em}div:where(.swal2-container) .swal2-select{min-width:50%;max-width:100%;padding:.375em .625em;background:var(--swal2-input-background);color:inherit;font-size:1.125em}div:where(.swal2-container) .swal2-radio,div:where(.swal2-container) .swal2-checkbox{align-items:center;justify-content:center;background:var(--swal2-background);color:inherit}div:where(.swal2-container) .swal2-radio label,div:where(.swal2-container) .swal2-checkbox label{margin:0 .6em;font-size:1.125em}div:where(.swal2-container) .swal2-radio input,div:where(.swal2-container) .swal2-checkbox input{flex-shrink:0;margin:0 .4em}div:where(.swal2-container) label:where(.swal2-input-label){display:flex;justify-content:center;margin:1em auto 0}div:where(.swal2-container) div:where(.swal2-validation-message){align-items:center;justify-content:center;margin:1em 0 0;padding:.625em;overflow:hidden;background:var(--swal2-validation-message-background);color:var(--swal2-validation-message-color);font-size:1em;font-weight:300}div:where(.swal2-container) div:where(.swal2-validation-message)::before{content:"!";display:inline-block;width:1.5em;min-width:1.5em;height:1.5em;margin:0 .625em;border-radius:50%;background-color:#f27474;color:#fff;font-weight:600;line-height:1.5em;text-align:center}div:where(.swal2-container) .swal2-progress-steps{flex-wrap:wrap;align-items:center;max-width:100%;margin:1.25em auto;padding:0;background:rgba(0,0,0,0);font-weight:600}div:where(.swal2-container) .swal2-progress-steps li{display:inline-block;position:relative}div:where(.swal2-container) .swal2-progress-steps .swal2-progress-step{z-index:20;flex-shrink:0;width:2em;height:2em;border-radius:2em;background:#2778c4;color:#fff;line-height:2em;text-align:center}div:where(.swal2-container) .swal2-progress-steps .swal2-progress-step.swal2-active-progress-step{background:#2778c4}div:where(.swal2-container) .swal2-progress-steps .swal2-progress-step.swal2-active-progress-step~.swal2-progress-step{background:var(--swal2-progress-step-background);color:#fff}div:where(.swal2-container) .swal2-progress-steps .swal2-progress-step.swal2-active-progress-step~.swal2-progress-step-line{background:var(--swal2-progress-step-background)}div:where(.swal2-container) .swal2-progress-steps .swal2-progress-step-line{z-index:10;flex-shrink:0;width:2.5em;height:.4em;margin:0 -1px;background:#2778c4}div:where(.swal2-icon){position:relative;box-sizing:content-box;justify-content:center;width:5em;height:5em;margin:2.5em auto .6em;zoom:var(--swal2-icon-zoom);border:.25em solid rgba(0,0,0,0);border-radius:50%;border-color:#000;font-family:inherit;line-height:5em;cursor:default;user-select:none}div:where(.swal2-icon) .swal2-icon-content{display:flex;align-items:center;font-size:3.75em}div:where(.swal2-icon).swal2-error{border-color:#f27474;color:#f27474}div:where(.swal2-icon).swal2-error .swal2-x-mark{position:relative;flex-grow:1}div:where(.swal2-icon).swal2-error [class^=swal2-x-mark-line]{display:block;position:absolute;top:2.3125em;width:2.9375em;height:.3125em;border-radius:.125em;background-color:#f27474}div:where(.swal2-icon).swal2-error [class^=swal2-x-mark-line][class$=left]{left:1.0625em;transform:rotate(45deg)}div:where(.swal2-icon).swal2-error [class^=swal2-x-mark-line][class$=right]{right:1em;transform:rotate(-45deg)}div:where(.swal2-icon).swal2-error.swal2-icon-show{animation:swal2-animate-error-icon .5s}div:where(.swal2-icon).swal2-error.swal2-icon-show .swal2-x-mark{animation:swal2-animate-error-x-mark .5s}div:where(.swal2-icon).swal2-warning{border-color:#f8bb86;color:#f8bb86}div:where(.swal2-icon).swal2-warning.swal2-icon-show{animation:swal2-animate-error-icon .5s}div:where(.swal2-icon).swal2-warning.swal2-icon-show .swal2-icon-content{animation:swal2-animate-i-mark .5s}div:where(.swal2-icon).swal2-info{border-color:#3fc3ee;color:#3fc3ee}div:where(.swal2-icon).swal2-info.swal2-icon-show{animation:swal2-animate-error-icon .5s}div:where(.swal2-icon).swal2-info.swal2-icon-show .swal2-icon-content{animation:swal2-animate-i-mark .8s}div:where(.swal2-icon).swal2-question{border-color:#87adbd;color:#87adbd}div:where(.swal2-icon).swal2-question.swal2-icon-show{animation:swal2-animate-error-icon .5s}div:where(.swal2-icon).swal2-question.swal2-icon-show .swal2-icon-content{animation:swal2-animate-question-mark .8s}div:where(.swal2-icon).swal2-success{border-color:#a5dc86;color:#a5dc86}div:where(.swal2-icon).swal2-success [class^=swal2-success-circular-line]{position:absolute;width:3.75em;height:7.5em;border-radius:50%}div:where(.swal2-icon).swal2-success [class^=swal2-success-circular-line][class$=left]{top:-0.4375em;left:-2.0635em;transform:rotate(-45deg);transform-origin:3.75em 3.75em;border-radius:7.5em 0 0 7.5em}div:where(.swal2-icon).swal2-success [class^=swal2-success-circular-line][class$=right]{top:-0.6875em;left:1.875em;transform:rotate(-45deg);transform-origin:0 3.75em;border-radius:0 7.5em 7.5em 0}div:where(.swal2-icon).swal2-success .swal2-success-ring{position:absolute;z-index:2;top:-0.25em;left:-0.25em;box-sizing:content-box;width:100%;height:100%;border:.25em solid rgba(165,220,134,.3);border-radius:50%}div:where(.swal2-icon).swal2-success .swal2-success-fix{position:absolute;z-index:1;top:.5em;left:1.625em;width:.4375em;height:5.625em;transform:rotate(-45deg)}div:where(.swal2-icon).swal2-success [class^=swal2-success-line]{display:block;position:absolute;z-index:2;height:.3125em;border-radius:.125em;background-color:#a5dc86}div:where(.swal2-icon).swal2-success [class^=swal2-success-line][class$=tip]{top:2.875em;left:.8125em;width:1.5625em;transform:rotate(45deg)}div:where(.swal2-icon).swal2-success [class^=swal2-success-line][class$=long]{top:2.375em;right:.5em;width:2.9375em;transform:rotate(-45deg)}div:where(.swal2-icon).swal2-success.swal2-icon-show .swal2-success-line-tip{animation:swal2-animate-success-line-tip .75s}div:where(.swal2-icon).swal2-success.swal2-icon-show .swal2-success-line-long{animation:swal2-animate-success-line-long .75s}div:where(.swal2-icon).swal2-success.swal2-icon-show .swal2-success-circular-line-right{animation:swal2-rotate-success-circular-line 4.25s ease-in}[class^=swal2]{-webkit-tap-highlight-color:rgba(0,0,0,0)}.swal2-show{animation:var(--swal2-show-animation)}.swal2-hide{animation:var(--swal2-hide-animation)}.swal2-noanimation{transition:none}.swal2-scrollbar-measure{position:absolute;top:-9999px;width:50px;height:50px;overflow:scroll}.swal2-rtl .swal2-close{margin-right:initial;margin-left:0}.swal2-rtl .swal2-timer-progress-bar{right:0;left:auto}.swal2-toast{box-sizing:border-box;grid-column:1/4 !important;grid-row:1/4 !important;grid-template-columns:min-content auto min-content;padding:1em;overflow-y:hidden;border:var(--swal2-toast-border);background:var(--swal2-background);box-shadow:var(--swal2-toast-box-shadow);pointer-events:auto}.swal2-toast>*{grid-column:2}.swal2-toast h2:where(.swal2-title){margin:.5em 1em;padding:0;font-size:1em;text-align:initial}.swal2-toast .swal2-loading{justify-content:center}.swal2-toast input:where(.swal2-input){height:2em;margin:.5em;font-size:1em}.swal2-toast .swal2-validation-message{font-size:1em}.swal2-toast div:where(.swal2-footer){margin:.5em 0 0;padding:.5em 0 0;font-size:.8em}.swal2-toast button:where(.swal2-close){grid-column:3/3;grid-row:1/99;align-self:center;width:.8em;height:.8em;margin:0;font-size:2em}.swal2-toast div:where(.swal2-html-container){margin:.5em 1em;padding:0;overflow:initial;font-size:1em;text-align:initial}.swal2-toast div:where(.swal2-html-container):empty{padding:0}.swal2-toast .swal2-loader{grid-column:1;grid-row:1/99;align-self:center;width:2em;height:2em;margin:.25em}.swal2-toast .swal2-icon{grid-column:1;grid-row:1/99;align-self:center;width:2em;min-width:2em;height:2em;margin:0 .5em 0 0}.swal2-toast .swal2-icon .swal2-icon-content{display:flex;align-items:center;font-size:1.8em;font-weight:bold}.swal2-toast .swal2-icon.swal2-success .swal2-success-ring{width:2em;height:2em}.swal2-toast .swal2-icon.swal2-error [class^=swal2-x-mark-line]{top:.875em;width:1.375em}.swal2-toast .swal2-icon.swal2-error [class^=swal2-x-mark-line][class$=left]{left:.3125em}.swal2-toast .swal2-icon.swal2-error [class^=swal2-x-mark-line][class$=right]{right:.3125em}.swal2-toast div:where(.swal2-actions){justify-content:flex-start;height:auto;margin:0;margin-top:.5em;padding:0 .5em}.swal2-toast button:where(.swal2-styled){margin:.25em .5em;padding:.4em .6em;font-size:1em}.swal2-toast .swal2-success{border-color:#a5dc86}.swal2-toast .swal2-success [class^=swal2-success-circular-line]{position:absolute;width:1.6em;height:3em;border-radius:50%}.swal2-toast .swal2-success [class^=swal2-success-circular-line][class$=left]{top:-0.8em;left:-0.5em;transform:rotate(-45deg);transform-origin:2em 2em;border-radius:4em 0 0 4em}.swal2-toast .swal2-success [class^=swal2-success-circular-line][class$=right]{top:-0.25em;left:.9375em;transform-origin:0 1.5em;border-radius:0 4em 4em 0}.swal2-toast .swal2-success .swal2-success-ring{width:2em;height:2em}.swal2-toast .swal2-success .swal2-success-fix{top:0;left:.4375em;width:.4375em;height:2.6875em}.swal2-toast .swal2-success [class^=swal2-success-line]{height:.3125em}.swal2-toast .swal2-success [class^=swal2-success-line][class$=tip]{top:1.125em;left:.1875em;width:.75em}.swal2-toast .swal2-success [class^=swal2-success-line][class$=long]{top:.9375em;right:.1875em;width:1.375em}.swal2-toast .swal2-success.swal2-icon-show .swal2-success-line-tip{animation:swal2-toast-animate-success-line-tip .75s}.swal2-toast .swal2-success.swal2-icon-show .swal2-success-line-long{animation:swal2-toast-animate-success-line-long .75s}.swal2-toast.swal2-show{animation:var(--swal2-toast-show-animation)}.swal2-toast.swal2-hide{animation:var(--swal2-toast-hide-animation)}@keyframes swal2-show{0%{transform:translate3d(0, -50px, 0) scale(0.9);opacity:0}100%{transform:translate3d(0, 0, 0) scale(1);opacity:1}}@keyframes swal2-hide{0%{transform:translate3d(0, 0, 0) scale(1);opacity:1}100%{transform:translate3d(0, -50px, 0) scale(0.9);opacity:0}}@keyframes swal2-animate-success-line-tip{0%{top:1.1875em;left:.0625em;width:0}54%{top:1.0625em;left:.125em;width:0}70%{top:2.1875em;left:-0.375em;width:3.125em}84%{top:3em;left:1.3125em;width:1.0625em}100%{top:2.8125em;left:.8125em;width:1.5625em}}@keyframes swal2-animate-success-line-long{0%{top:3.375em;right:2.875em;width:0}65%{top:3.375em;right:2.875em;width:0}84%{top:2.1875em;right:0;width:3.4375em}100%{top:2.375em;right:.5em;width:2.9375em}}@keyframes swal2-rotate-success-circular-line{0%{transform:rotate(-45deg)}5%{transform:rotate(-45deg)}12%{transform:rotate(-405deg)}100%{transform:rotate(-405deg)}}@keyframes swal2-animate-error-x-mark{0%{margin-top:1.625em;transform:scale(0.4);opacity:0}50%{margin-top:1.625em;transform:scale(0.4);opacity:0}80%{margin-top:-0.375em;transform:scale(1.15)}100%{margin-top:0;transform:scale(1);opacity:1}}@keyframes swal2-animate-error-icon{0%{transform:rotateX(100deg);opacity:0}100%{transform:rotateX(0deg);opacity:1}}@keyframes swal2-rotate-loading{0%{transform:rotate(0deg)}100%{transform:rotate(360deg)}}@keyframes swal2-animate-question-mark{0%{transform:rotateY(-360deg)}100%{transform:rotateY(0)}}@keyframes swal2-animate-i-mark{0%{transform:rotateZ(45deg);opacity:0}25%{transform:rotateZ(-25deg);opacity:.4}50%{transform:rotateZ(15deg);opacity:.8}75%{transform:rotateZ(-5deg);opacity:1}100%{transform:rotateX(0);opacity:1}}@keyframes swal2-toast-show{0%{transform:translateY(-0.625em) rotateZ(2deg)}33%{transform:translateY(0) rotateZ(-2deg)}66%{transform:translateY(0.3125em) rotateZ(2deg)}100%{transform:translateY(0) rotateZ(0deg)}}@keyframes swal2-toast-hide{100%{transform:rotateZ(1deg);opacity:0}}@keyframes swal2-toast-animate-success-line-tip{0%{top:.5625em;left:.0625em;width:0}54%{top:.125em;left:.125em;width:0}70%{top:.625em;left:-0.25em;width:1.625em}84%{top:1.0625em;left:.75em;width:.5em}100%{top:1.125em;left:.1875em;width:.75em}}@keyframes swal2-toast-animate-success-line-long{0%{top:1.625em;right:1.375em;width:0}65%{top:1.25em;right:.9375em;width:0}84%{top:.9375em;right:0;width:1.125em}100%{top:.9375em;right:.1875em;width:1.375em}}');function qv(n){let e=!1;const t=()=>{n.innerHTML=`
  ...
  `;const g=document.getElementById("coletaForm"),x=document.getElementById("formacoesContainer"),R=(s==null?void 0:s.formacoes)||[];if(R.length>0?R.forEach((F,M)=>{x.insertAdjacentHTML("beforeend",p(M,F)),l=M+1}):(x.insertAdjacentHTML("beforeend",p(0)),l=1),s){Object.keys(s).forEach(A=>{if(A!=="formacoes"&&A!=="foto"&&A!=="capacitacoes"&&A!=="outras_capacitacoes"){const y=g.elements[A];y&&(y.type==="checkbox"?y.checked=!!s[A]:y.value=s[A])}}),(s.capacitacoes||[]).forEach(A=>{const y=g.querySelector(`.chk-capacitacao[value="${A}"]`);y&&(y.checked=!0)});const M=g.querySelector('[name="outras_capacitacoes"]');M&&s.outras_capacitacoes&&(M.value=s.outras_capacitacoes)}if(c){g.querySelectorAll("input, select, textarea").forEach(m=>{m.disabled=!0,m.tagName==="INPUT"&&m.type!=="checkbox"&&m.classList.add("bg-slate-50","text-slate-500","cursor-not-allowed")}),g.querySelectorAll('input[type="file"]').forEach(m=>{const v=m.closest(".w-full.rounded-xl.border")||m.closest(".flex-1.rounded-xl");v&&(v.style.display="none")});const A=document.getElementById("btnAdicionarFormacao");A&&(A.style.display="none"),g.querySelectorAll(".btn-remover-formacao").forEach(m=>m.style.display="none")}const S=document.getElementById("btnAdicionarFormacao");S&&S.addEventListener("click",()=>{x.insertAdjacentHTML("beforeend",p(l)),l++}),x.addEventListener("click",F=>{const M=F.target.closest(".btn-remover-formacao");M&&M.closest(".formacao-card").remove()}),x.addEventListener("change",F=>{if(F.target.classList.contains("chk-e-graduacao")){const M=F.target.closest(".formacao-card"),A=M.querySelector(".block-diploma"),y=M.querySelector(".block-graduacao");F.target.checked?(A.classList.add("hidden"),y.classList.remove("hidden")):(A.classList.remove("hidden"),y.classList.add("hidden"))}}),g.addEventListener("change",F=>{if(F.target.type==="file"){const M=F.target.files[0];if(M){let y=[];if(F.target.id==="foto"?y=["image/png","image/jpeg","image/jpg"]:y=["application/pdf","image/png","image/jpeg","image/jpg"],!y.includes(M.type)){ie.fire({icon:"error",title:"Formato não permitido",text:F.target.id==="foto"?"Por favor, selecione apenas arquivos de imagem PNG ou JPG/JPEG para a foto.":"Por favor, selecione apenas arquivos PDF ou imagens JPG/PNG/JPEG.",confirmButtonColor:"#ef4444"}),F.target.value="";return}M.size>5242880&&(ie.fire({icon:"error",title:"Arquivo muito pesado",text:"O tamanho máximo permitido é de 5MB. O seu arquivo possui "+(M.size/(1024*1024)).toFixed(2)+"MB.",confirmButtonColor:"#ef4444"}),F.target.value="")}}}),document.getElementById("btnVoltarInicio").addEventListener("click",()=>yt("inicio")),c&&document.getElementById("btnVoltarInicioFooter").addEventListener("click",()=>yt("inicio")),document.getElementById("btnLogout").addEventListener("click",async()=>{(await ie.fire({title:"Deseja sair?",text:"Você será desconectado do sistema.",icon:"question",showCancelButton:!0,confirmButtonText:"Sair",cancelButtonText:"Permanecer",confirmButtonColor:"#ef4444",cancelButtonColor:"#94a3b8"})).isConfirmed&&(Fe?await Pu():(localStorage.removeItem("demo_user"),localStorage.removeItem("demo_role"),window.location.reload()))});const U=document.getElementById("btnIrAdmin");U&&U.addEventListener("click",()=>yt("admin"));const Q=document.getElementById("btnCancelar");Q&&Q.addEventListener("click",()=>{ie.fire({title:"Deseja cancelar?",text:"As informações não salvas serão perdidas.",icon:"warning",showCancelButton:!0,confirmButtonColor:"#3085d6",cancelButtonColor:"#d33",confirmButtonText:"Sim, cancelar",cancelButtonText:"Continuar preenchendo"}).then(F=>{F.isConfirmed&&yt("inicio")})});const re=async(F,M)=>{if(Fe){const A=j_(ap,M);return await $_(A,F),await H_(A)}return"https://example.com/mock-file-upload.pdf"},ue=async()=>{var G,we,ht;const F={},M=new FormData(g),A=["foto","outras_capacitacoes","e_docente"];for(const[ye,Me]of M.entries())!ye.startsWith("titulacao_")&&!ye.startsWith("local_formacao_")&&!ye.startsWith("ano_conclusao_")&&!ye.startsWith("e_graduacao_")&&!ye.startsWith("diploma_")&&!ye.startsWith("historico_")&&!ye.startsWith("matricula_")&&!ye.startsWith("capacitacao_")&&!A.includes(ye)&&(F[ye]=Me);F.e_docente=g.elements.e_docente.checked,F.email=e.email.toLowerCase().trim(),F.lastUpdated=new Date().toISOString();const y=document.getElementById("foto");let m=(s==null?void 0:s.fotoUrl)||"";if(y&&y.files[0]){const ye=y.files[0].name.split(".").pop();m=await re(y.files[0],`fotos/${e.email.replace(/[@.]/g,"_")}_foto_${Date.now()}.${ye}`)}F.fotoUrl=m;const v=[];g.querySelectorAll(".chk-capacitacao:checked").forEach(ye=>v.push(ye.value)),F.capacitacoes=v,F.outras_capacitacoes=g.querySelector('[name="outras_capacitacoes"]').value.trim();const T=[],b=x.querySelectorAll(".formacao-card");for(let ye of b){const Me=ye.getAttribute("data-index"),Qr=ye.querySelector(`[name="titulacao_${Me}"]`).value.trim(),il=ye.querySelector(`[name="local_formacao_${Me}"]`).value.trim(),ao=ye.querySelector(`[name="ano_conclusao_${Me}"]`).value.trim(),Ds=ye.querySelector(`[name="e_graduacao_${Me}"]`).checked;let Xr=ye.querySelector(`[name="diplomaUrl_${Me}"]`).value||"",In=ye.querySelector(`[name="historicoUrl_${Me}"]`).value||"",pr=ye.querySelector(`[name="matriculaUrl_${Me}"]`).value||"";const mr=(G=ye.querySelector(`[name="diploma_${Me}"]`))==null?void 0:G.files[0],gr=(we=ye.querySelector(`[name="historico_${Me}"]`))==null?void 0:we.files[0],wr=(ht=ye.querySelector(`[name="matricula_${Me}"]`))==null?void 0:ht.files[0];if(Ds){if(gr){const Cn=gr.name.split(".").pop();In=await re(gr,`historicos/${e.email.replace(/[@.]/g,"_")}_historico_${Me}_${Date.now()}.${Cn}`)}if(wr){const Cn=wr.name.split(".").pop();pr=await re(wr,`matriculas/${e.email.replace(/[@.]/g,"_")}_matricula_${Me}_${Date.now()}.${Cn}`)}Xr=""}else{if(mr){const Cn=mr.name.split(".").pop();Xr=await re(mr,`diplomas/${e.email.replace(/[@.]/g,"_")}_diploma_${Me}_${Date.now()}.${Cn}`)}In="",pr=""}T.push({titulacao:Qr,local_formacao:il,ano_conclusao:ao,e_graduacao:Ds,diplomaUrl:Xr,historicoUrl:In,matriculaUrl:pr})}return F.formacoes=T,F},pe=document.getElementById("btnSalvarRascunho");return pe&&pe.addEventListener("click",async()=>{if(!r){r=!0,ie.fire({title:"Salvando Rascunho...",text:"Gravando informações e arquivos.",allowOutsideClick:!1,didOpen:()=>ie.showLoading()});try{const F=await ue();if(F.status="editando",F.pendencias=o,Fe)await Bi(bn(St,"coletas",e.email.toLowerCase().trim()),F);else{localStorage.setItem(`demo_coleta_${e.email}`,JSON.stringify(F));const M=JSON.parse(localStorage.getItem("all_demo_coletas")||"{}");M[e.email]=F,localStorage.setItem("all_demo_coletas",JSON.stringify(M))}await ie.fire({icon:"success",title:"Rascunho Salvo!",text:"Seus dados foram guardados como rascunho com sucesso.",confirmButtonColor:"#f59e0b"}),yt("inicio")}catch(F){console.error(F),ie.fire({icon:"error",title:"Erro ao Salvar",text:F.message||"Houve um erro no salvamento do rascunho.",confirmButtonColor:"#ef4444"})}finally{r=!1}}}),g&&g.addEventListener("submit",async F=>{var m,v,E;if(F.preventDefault(),r)return;const M=x.querySelectorAll(".formacao-card");let A=!1;for(let T of M){const b=T.getAttribute("data-index"),G=T.querySelector(`[name="e_graduacao_${b}"]`).checked,we=T.querySelector(`[name="diplomaUrl_${b}"]`).value||((m=T.querySelector(`[name="diploma_${b}"]`))==null?void 0:m.files[0]),ht=T.querySelector(`[name="historicoUrl_${b}"]`).value||((v=T.querySelector(`[name="historico_${b}"]`))==null?void 0:v.files[0]),ye=T.querySelector(`[name="matriculaUrl_${b}"]`).value||((E=T.querySelector(`[name="matricula_${b}"]`))==null?void 0:E.files[0]);if(G){if(!ht||!ye){A=!0;break}}else if(!we){A=!0;break}}if(A){ie.fire({icon:"error",title:"Documentos Pendentes",text:"Você precisa anexar os documentos exigidos para todas as suas formações acadêmicas (Diploma para concluídos, ou Histórico + Comprovante de Matrícula para graduações em andamento) antes de enviar para análise.",confirmButtonColor:"#ef4444"});return}if((await ie.fire({title:"Deseja enviar?",text:"O formulário será bloqueado para edição até que a administração conclua a revisão.",icon:"question",showCancelButton:!0,confirmButtonText:"Sim, enviar",cancelButtonText:"Revisar",confirmButtonColor:"#2563eb",cancelButtonColor:"#94a3b8"})).isConfirmed){r=!0,ie.fire({title:"Enviando Cadastro...",text:"Submetendo dados e arquivos para homologação.",allowOutsideClick:!1,didOpen:()=>ie.showLoading()});try{const T=await ue();if(T.status="em_analise",T.pendencias="",Fe)await Bi(bn(St,"coletas",e.email.toLowerCase().trim()),T);else{localStorage.setItem(`demo_coleta_${e.email}`,JSON.stringify(T));const b=JSON.parse(localStorage.getItem("all_demo_coletas")||"{}");b[e.email]=T,localStorage.setItem("all_demo_coletas",JSON.stringify(b))}await ie.fire({icon:"success",title:"Enviado com sucesso!",text:"Seu formulário está em fase de análise pela equipe do LAMES.",confirmButtonColor:"#2563eb"}),yt("inicio")}catch(T){console.error(T),ie.fire({icon:"error",title:"Erro ao Enviar",text:T.message||"Houve um erro ao submeter seu formulário.",confirmButtonColor:"#ef4444"})}finally{r=!1}}}),{destroy:()=>{}}}async function Gv(n,e,t){let r="registros",s="",i="",o="",l="",c="",h=[],p=[],g=[];localStorage.getItem("demo_whitelist")||localStorage.setItem("demo_whitelist",JSON.stringify({"admin@lames.org":{email:"admin@lames.org",role:"admin"},"colab@lames.org":{email:"colab@lames.org",role:"colaborador"}})),localStorage.getItem("all_demo_coletas")||localStorage.setItem("all_demo_coletas",JSON.stringify({"colab@lames.org":{nome_completo:"Antônio da Silva",tipo_integrante:"bolsista",cpf:"111.222.333-44",rg:"MG-12.345.678",endereco:"Rua das Flores, 123, Rio de Janeiro - RJ",email:"colab@lames.org",telefone:"(21) 98888-7777",grupo_sanguineo:"O+",alergias:"Nenhuma",contato_emergencia:"Maria (Mãe) - (21) 99999-8888",titulacao:"Mestre",local_formacao:"FIOCRUZ",ano_conclusao:"2023",diplomaUrl:"https://example.com/mock-diploma.pdf",vinculo:"Bolsista de Mestrado",prazo_vinculo:"24 meses",origem_vinculo:"CNPq",cargo_nivel:"Nível I",situacao_atual:"Ativo",e_docente:!1,orientador:"Dr. João Medeiros",status:"em_analise",pendencias:"",lastUpdated:new Date().toISOString()}})),localStorage.getItem("all_demo_usuarios")||localStorage.setItem("all_demo_usuarios",JSON.stringify({"admin@lames.org":{email:"admin@lames.org",role:"admin",lastAccess:new Date().toISOString()},"colab@lames.org":{email:"colab@lames.org",role:"colaborador",lastAccess:new Date().toISOString()}}));const x=async()=>{if(Fe){try{h=(await $l(Vl(St,"coletas"))).docs.map(v=>v.data())}catch(m){console.error("Erro ao buscar coletas:",m)}try{p=(await $l(Vl(St,"whitelist"))).docs.map(v=>v.data())}catch(m){console.error("Erro ao buscar whitelist:",m)}try{g=(await $l(Vl(St,"usuarios"))).docs.map(v=>v.data())}catch(m){console.error("Erro ao buscar usuários registrados:",m)}}else{const m=JSON.parse(localStorage.getItem("demo_whitelist")||"{}");p=Object.values(m);const v=JSON.parse(localStorage.getItem("all_demo_coletas")||"{}");h=Object.values(v);const E=JSON.parse(localStorage.getItem("all_demo_usuarios")||"{}");g=Object.values(E)}},R=m=>{switch(m){case"deferido":return'<span class="bg-green-50 text-green-700 border border-green-100 text-xs px-2.5 py-0.5 rounded-full font-bold uppercase tracking-wider">Deferido</span>';case"indeferido":return'<span class="bg-red-50 text-red-700 border border-red-100 text-xs px-2.5 py-0.5 rounded-full font-bold uppercase tracking-wider">Indeferido</span>';case"em_analise":return'<span class="bg-blue-50 text-blue-700 border border-blue-100 text-xs px-2.5 py-0.5 rounded-full font-bold uppercase tracking-wider animate-pulse">Em Análise</span>';case"editando":default:return'<span class="bg-amber-50 text-amber-700 border border-amber-100 text-xs px-2.5 py-0.5 rounded-full font-bold uppercase tracking-wider">Rascunho</span>'}},S=()=>{n.innerHTML=`
    ...
    `,document.getElementById("btnVoltarInicio").addEventListener("click",()=>yt("inicio")),document.getElementById("btnPreencherForm").addEventListener("click",()=>yt("formulario")),document.getElementById("btnLogout").addEventListener("click",async()=>{(await ie.fire({title:"Deseja sair?",icon:"question",showCancelButton:!0,confirmButtonText:"Sair",cancelButtonText:"Permanecer",confirmButtonColor:"#ef4444",cancelButtonColor:"#94a3b8"})).isConfirmed&&(Fe?await Pu():(localStorage.removeItem("demo_user"),localStorage.removeItem("demo_role"),window.location.reload()))}),document.getElementById("tabRegistros").addEventListener("click",()=>{r="registros",S()}),document.getElementById("tabWhitelist").addEventListener("click",()=>{r="whitelist",S()}),document.getElementById("tabUsuarios").addEventListener("click",()=>{r="usuarios",S()}),re()},B=()=>{const m=h.filter(v=>{const E=(v.nome_completo||"").toLowerCase(),T=(v.email||"").toLowerCase(),b=E.includes(s.toLowerCase())||T.includes(s.toLowerCase()),G=i===""||v.tipo_integrante===i,we=v.status||"editando";return b&&G&&(o===""||we===o)});return`
      <!-- Filters bar -->
          ...
          <tbody class="divide-y divide-slate-100 text-slate-700">
            ...
            `:m.map(v=>`
              <tr class="hover:bg-slate-50/50 transition">
                ...
                <td class="p-4 px-6 text-center">${R(v.status)}</td>
    ...
    `},pe=()=>{const m=h.filter(v=>{const E=(v.nome_completo||"").toLowerCase(),T=(v.email||"").toLowerCase(),b=E.includes(s.toLowerCase())||T.includes(s.toLowerCase()),G=i===""||v.tipo_integrante===i,we=v.status||"editando";return b&&G&&(o===""||we===o)});return`
      <tbody class="divide-y divide-slate-100 text-slate-700">
        ${m.length===0?`
          <tr>
            <td colspan="6" class="text-center p-12 text-slate-400">Nenhum registro encontrado.</td>
    ...
    `},F=()=>{n.querySelectorAll(".btnVerDetalhes").forEach(v=>{v.addEventListener("click",E=>{const T=E.target.getAttribute("data-email"),b=h.find(G=>G.email===T);b&&y(b)})})},M=async(m,v,E,T="")=>{ie.fire({title:"Atualizando cadastro...",allowOutsideClick:!1,didOpen:()=>ie.showLoading()});try{const b={...E,status:v,pendencias:T,lastUpdated:new Date().toISOString()};if(Fe)await Bi(bn(St,"coletas",m),b);else{const G=JSON.parse(localStorage.getItem("all_demo_coletas")||"{}");G[m]=b,localStorage.setItem("all_demo_coletas",JSON.stringify(G)),localStorage.setItem(`demo_coleta_${m}`,JSON.stringify(b))}await x(),await ie.fire({icon:"success",title:"Status Atualizado!",text:`O cadastro de ${b.nome_completo||m} foi definido como ${v.toUpperCase()}.`,confirmButtonColor:"#2563eb"}),S()}catch(b){console.error(b),ie.fire({icon:"error",title:"Ops! Ocorreu um erro",text:b.message||"Erro ao alterar status.",confirmButtonColor:"#ef4444"})}},A=async m=>{if(!window.html2pdf)throw new Error("Biblioteca html2pdf.js não encontrada. Recarregue a página.");let v="";m.formacoes&&Array.isArray(m.formacoes)&&m.formacoes.length>0?v=m.formacoes.map((G,we)=>`
        <div style="padding: 10px; background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; margin-bottom: 8px; font-size: 11px; page-break-inside: avoid;">
          <div style="display: flex; justify-content: space-between; border-bottom: 1px solid #e2e8f0; padding-bottom: 4px; margin-bottom: 6px;">
            <b style="color: #0f172a; font-family: sans-serif;"># ${we+1} - ${G.titulacao||"-"}</b>
            <span style="font-weight: bold; font-family: sans-serif; font-size: 10px; color: ${G.e_graduacao?"#b45309":"#15803d"};">
              ${G.e_graduacao?"Graduação em Andamento":"Concluído"}
            </span>
          </div>
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 4px; font-family: sans-serif;">
            <div><b style="color: #64748b;">Local:</b> <span style="color: #334155;">${G.local_formacao||"-"}</span></div>
            <div><b style="color: #64748b;">Conclusão/Previsão:</b> <span style="color: #334155;">${G.ano_conclusao||"-"}</span></div>
          </div>
        </div>
      `).join(""):v=`
    ...
    `).join("")||'<span style="color: #94a3b8; font-size: 11px; font-family: sans-serif;">Nenhum curso selecionado</span>',T=document.createElement("div");T.style.position="absolute",T.style.left="-9999px",T.style.top="-9999px",T.style.width="170mm",T.style.boxSizing="border-box",T.style.backgroundColor="#ffffff",T.innerHTML=`
    ...
    `,document.body.appendChild(T);const b={margin:[10,10,10,10],filename:`ficha_cadastral_${(m.nome_completo||"colaborador").replace(/\s+/g,"_").toLowerCase()}.pdf`,image:{type:"jpeg",quality:.98},html2canvas:{scale:2,useCORS:!0},jsPDF:{unit:"mm",format:"a4",orientation:"portrait"}};try{await window.html2pdf().set(b).from(T).save()}finally{document.body.removeChild(T)}},y=m=>{const v=m.status==="em_analise",E=m.status==="indeferido";let T="";m.formacoes&&Array.isArray(m.formacoes)?T=m.formacoes.map((G,we)=>`
        <div class="p-3 bg-slate-50 rounded-xl border border-slate-100 space-y-2 text-xs">
          <div class="flex justify-between items-center border-b border-slate-200/50 pb-1.5 mb-1.5">
            <span class="font-bold text-slate-900"># ${we+1} - ${G.titulacao||"-"}</span>
            <span>${G.e_graduacao?'<span class="bg-amber-100 text-amber-800 text-[10px] px-2 py-0.5 rounded-full font-bold uppercase">Graduação em Andamento</span>':'<span class="bg-green-100 text-green-800 text-[10px] px-2 py-0.5 rounded-full font-bold uppercase">Concluído</span>'}</span>
          </div>
          <div class="grid grid-cols-2 gap-y-1.5 gap-x-4">
            <div><b class="text-slate-500">Local:</b> <span class="text-slate-800 font-medium">${G.local_formacao||"-"}</span></div>
            <div><b class="text-slate-500">Conclusão/Previsão:</b> <span class="text-slate-800 font-medium">${G.ano_conclusao||"-"}</span></div>
            ...
            <div class="col-span-2 pt-1.5 border-t border-slate-200/40 mt-1 flex flex-col gap-1">
              ...
              <div class="flex flex-wrap gap-3 font-semibold mt-0.5">
                ${G.e_graduacao?`
                  ${G.historicoUrl?`<a href="${G.historicoUrl}" target="_blank" class="text-blue-600 hover:underline">Histórico Escolar</a>`:'<span class="text-red-500">Histórico não enviado</span>'}
                  ${G.matriculaUrl?`<a href="${G.matriculaUrl}" target="_blank" class="text-blue-600 hover:underline">Comprovante Matrícula</a>`:'<span class="text-red-500">Comprovante não enviado</span>'}
                `:`
                  ${G.diplomaUrl?`<a href="${G.diplomaUrl}" target="_blank" class="text-blue-600 hover:underline">Diploma</a>`:'<span class="text-red-500">Diploma não enviado</span>'}
                `}
              </div>
            </div>
          </div>
      ...
      `;const b=(m.capacitacoes||[]).map(G=>`
      <span class="bg-blue-50 text-blue-700 border border-blue-100 text-[10px] px-2.5 py-1 rounded-full font-bold">${G}</span>
    `).join(" ")||'<span class="text-slate-400">Nenhum curso selecionado</span>';ie.fire({title:`<span class="text-lg font-extrabold text-slate-900">Ficha Cadastral: ${m.nome_completo||"Colaborador"}</span>`,html:`
      ...
      `,width:"600px",showConfirmButton:!0,confirmButtonText:"Baixar Ficha",confirmButtonColor:"#2563eb",showCancelButton:!0,cancelButtonText:"Fechar Ficha",cancelButtonColor:"#64748b",showLoaderOnConfirm:!0,preConfirm:async()=>{try{return await A(m),!1}catch(G){ie.showValidationMessage(`Erro ao gerar PDF: ${G.message}`)}},didOpen:()=>{v&&(document.getElementById("btnModalDeferir").addEventListener("click",async()=>{(await ie.fire({title:"Deferir Cadastro?",text:"Isso aprovará e homologará em definitivo as informações do colaborador.",icon:"question",showCancelButton:!0,confirmButtonText:"Sim, deferir",cancelButtonText:"Cancelar",confirmButtonColor:"#16a34a",cancelButtonColor:"#94a3b8"})).isConfirmed&&await M(m.email,"deferido",m)}),document.getElementById("btnModalIndeferir").addEventListener("click",async()=>{const{value:G,isConfirmed:we}=await ie.fire({title:"Apontar Pendências",input:"textarea",inputLabel:"Descreva detalhadamente o que o colaborador precisa corrigir no cadastro:",inputPlaceholder:"Ex: O anexo do diploma está ilegível. Favor preencher o campo RG corretamente.",inputAttributes:{"aria-label":"Descreva detalhadamente o que o colaborador precisa corrigir no cadastro"},showCancelButton:!0,confirmButtonText:"Solicitar Correção",cancelButtonText:"Voltar",confirmButtonColor:"#ef4444",cancelButtonColor:"#94a3b8",inputValidator:ht=>{if(!ht)return"Você precisa digitar o motivo da pendência!"}});we&&G&&await M(m.email,"indeferido",m,G)}))}})};return ie.fire({title:"Carregando painel...",allowOutsideClick:!1,didOpen:()=>ie.showLoading()}),await x(),ie.close(),S(),{destroy:()=>{}}}async function Wv(n,e,t){let r="nao_iniciado",s="",i=null;try{if(Fe){const h=bn(St,"coletas",e.email.toLowerCase().trim()),p=await Au(h);p.exists()&&(i=p.data(),r=i.status||"editando",s=i.pendencias||"")}else{const h=localStorage.getItem(`demo_coleta_${e.email}`);h&&(i=JSON.parse(h),r=i.status||"editando",s=i.pendencias||"")}}catch(h){console.error("Erro ao buscar status do cadastro:",h)}const o=()=>{switch(r){case"editando":return`
